        ...
        if (payment_methods == "Stripe") {
            ...
            place_order().done(function (result) {
                if (result.error == false) {
                    ...
                    $("#place_order_btn").html('Order placed.');
                } else {
                    Toast.fire({
                        icon: 'error',
        ...
        return $.ajax({
            ...
            success: function (data) {
                ...
                if (data.error == false) {
                    ...
                    $("#checkout_msg").html('<div class="mt-2 alert alert-icon alert-primary alert-bg alert-inline show-code-action">'+data.message+'</div>');
                } else {
                    /*Toast.fire({
                        icon: 'error',
                        title: data.message
                    });*/
                    $("#checkout_msg").html('<div class="mt-2 alert alert-icon alert-error alert-bg alert-inline show-code-action">'+data.message+'</div>');
                }
            }
        })
    }
