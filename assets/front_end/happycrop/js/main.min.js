...
$(document).ready(function (){
   ...
   if(document.getElementById('orderChartView')) 
    {
        $.ajax({
            url: base_url + '/my-account/fetch_orders',
            type: 'GET',
            dataType: 'json',
            success: function (result) {
                $(window).on,
                    function (e, t, a) {
                        ...
                        n = function (e, t, a) {
                            ...
                            h = {
                                ...
                                switch ((e || a("#orderChartView .chart-action").find(".active")).attr("href")) {
                                    case "#scoreLineToDay":
    ...
    if(document.getElementById('orderChartView2')) 
    {
        $.ajax({
            url: base_url + '/my-account/fetch_orders_count',
            type: 'GET',
            dataType: 'json',
            success: function (result) {
                $(window).on,
                    function (e, t, a) {
                        ...
                        n = function (e, t, a) {
                            ...
                            h = {
                                ...
                                switch ((e || a("#orderChartView2 .chart-action").find(".active")).attr("href")) {
...
$('.table-resp').on('all.bs.table', function (e, name, args) {
...
{
    $('.table-resp th').each(function(i, elem) {
      var num = i + 1;  
      //alert(i);
      $('.table-resp td:nth-child(' + num + ')').attr('data-label', $(elem).text());
  }); 
}
...
function AjaxModal(url, title)
{
    ...
    jQuery('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="'+base_url +'assets/pre-loader.gif" /></div>');
...
function save_storage_address(url)
{
    $.ajax({
        url: url,
        type: 'POST',
        cache: false,
        data: $("#adminPopForm").serialize(),
        dataType: "json",
        beforeSend: function () {
            $('#btn_sv').html('Please Wait..').attr('disabled', true);
        },
        success: function(response)
        {
            $('#modal_ajax').modal('hide');
            $("#adminPopForm")[0].reset();
