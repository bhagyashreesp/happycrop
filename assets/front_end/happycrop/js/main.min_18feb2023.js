...
$.extend($.easing, {
    ...
    function(t) {
        var e, i, a, n, o, s, r;
        SVMindLogic.$window = t(window), SVMindLogic.$body = t(document.body), SVMindLogic.status = "", SVMindLogic.isIE = navigator.userAgent.indexOf("Trident") >= 0, SVMindLogic.isEdge = navigator.userAgent.indexOf("Edge") >= 0, SVMindLogic.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), SVMindLogic.call = function(t, e) {
            setTimeout(t, e)
        }, SVMindLogic.parseOptions = function(t) {
            return "string" == typeof t ? JSON.parse(t.replace(/'/g, '"').replace(";", "")) : {}
        }, SVMindLogic.parseTemplate = function(t, e) {
            return t.replace(/\{\{(\w+)\}\}/g, (function() {
                return e[arguments[1]]
            }))
        }, SVMindLogic.byId = function(t) {
            return document.getElementById(t)
        }, SVMindLogic.byTag = function(t, e) {
            return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t)
        }, SVMindLogic.byClass = function(t, e) {
            return e ? e.getElementsByClassName(t) : document.getElementsByClassName(t)
        }, SVMindLogic.setCookie = function(t, e, i) {
            var a = new Date;
            a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3), document.cookie = t + "=" + e + ";expires=" + a.toUTCString() + ";path=/"
        }, SVMindLogic.getCookie = function(t) {
            ...
            return ""
        }, SVMindLogic.$ = function(e) {
            return e instanceof jQuery ? e : t(e)
        }, SVMindLogic.isOnScreen = function(t) {
        ...
        }, SVMindLogic.appear = function(e, i, a) {
        ...
        }, SVMindLogic.requestTimeout = function(t, e) {
        ...
        }, SVMindLogic.requestInterval = function(t, e, i) {
        ...
        }, SVMindLogic.deleteTimeout = function(t) {
            if (t) {
                var e = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame;
                return e ? t.val ? e(t.val) : void 0 : clearTimeout(t)
            }
        }, SVMindLogic.setTab = function(e) {
            SVMindLogic.$body.on("click", ".tab .nav-link", (function(e) {
                var i = t(this);
        ...
        }, SVMindLogic.initCartAction = function(e) {
            SVMindLogic.$body.on("click", e, (function(e) {
        ...
        }, SVMindLogic.initScrollTopButton = function() {
            var e = SVMindLogic.byId("scroll-top");
            ...
            SVMindLogic.call(i, 500), window.addEventListener("scroll", i, {
                passive: !0
            })
        }, SVMindLogic.stickyDefaultOptions = {
            minWidth: 992,
            maxWidth: 2e4,
            top: !1,
            hide: !1,
            scrollMode: !0
        }, SVMindLogic.stickyToolboxOptions = {
            minWidth: 0,
            maxWidth: 767,
            top: !1,
            scrollMode: !0
        }, SVMindLogic.stickyProductOptions = {
            minWidth: 0,
            maxWidth: 2e4,
            scrollMode: !0,
            top: !1,
            hide: !1
        }, SVMindLogic.windowResized = function(e) {
            return e == SVMindLogic.resizeTimeStamp || (void 0 === window.innerHeight && (window.innerWidth = t(window).width() + SVMindLogic.getScrollbarWidth()), SVMindLogic.resizeChanged = SVMindLogic.canvasWidth != window.innerWidth, SVMindLogic.canvasWidth = window.innerWidth, SVMindLogic.resizeTimeStamp = e), SVMindLogic.resizeChanged
        }, SVMindLogic.getScrollbarWidth = function() {
            if (void 0 === SVMindLogic.scrollbarSize) {
                var t = document.createElement("div");
                t.style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;", document.body.appendChild(t), SVMindLogic.scrollbarSize = t.offsetWidth - t.clientWidth, document.body.removeChild(t)
            }
            return SVMindLogic.scrollbarSize
        }, SVMindLogic.stickyContent = function() {
            function e(t, e) {
                return this.init(t, e)
            }

            function i() {
                SVMindLogic.$window.trigger("sticky_refresh.wolmart", {
                    index: 0,
                    offsetTop: 0
                })
            }
            ...
            function a(t) {
                t && !SVMindLogic.windowResized(t.timeStamp) || (SVMindLogic.$window.trigger("sticky_refresh_size.wolmart"), i())
            }
            return e.prototype.init = function(e, i) {
                    this.$el = e, this.options = t.extend(!0, {}, SVMindLogic.stickyDefaultOptions, i, SVMindLogic.parseOptions(e.attr("data-sticky-options"))), SVMindLogic.$window.on("sticky_refresh.wolmart", this.refresh.bind(this)).on("sticky_refresh_size.wolmart", this.refreshSize.bind(this))
                    ...
                    this.isWrap ? e || this.unwrap() : e && this.wrap(), SVMindLogic.sticky_top_height = 0, t && setTimeout(this.refreshSize.bind(this), 50)
                    ...
                    i > this.top && this.isWrap ? (this.height = a[0].offsetHeight, a.hasClass("fixed") || a.parent().css("height", this.height + "px"), a.hasClass("fix-top") ? (a.css("margin-top", e.offsetTop + "px"), this.zIndex = this.options.max_index - e.index) : a.hasClass("fix-bottom") ? (a.css("margin-bottom", e.offsetBottom + "px"), this.zIndex = this.options.max_index - e.index) : a.css({
                        ...
                        "z-index": this.zIndex
                    }), this.options.scrollMode ? (this.scrollPos >= i && a.hasClass("fix-top") || this.scrollPos <= i && a.hasClass("fix-bottom") ? (a.addClass("fixed"), this.onFixed && this.onFixed(), a.hasClass("product-sticky-content") && SVMindLogic.$body.addClass("addtocart-fixed")) : (a.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""), this.onUnfixed && this.onUnfixed(), a.hasClass("product-sticky-content") && SVMindLogic.$body.removeClass("addtocart-fixed")), this.scrollPos = i) : (a.addClass("fixed"), this.onFixed && this.onFixed()), a.is(".fixed.fix-top") ? (e.offsetTop += a[0].offsetHeight, SVMindLogic.sticky_top_height = e.offsetTop) : a.is(".fixed.fix-bottom") && (e.offsetBottom += a[0].offsetHeight)) : (a.parent().css("height", ""), a.removeClass("fixed").css({
                        "margin-top": "",
                        "margin-bottom": "",
                        "z-index": ""
                    }), this.onUnfixed && this.onUnfixed(), a.hasClass("product-sticky-content") && SVMindLogic.$body.removeClass("addtocart-fixed"))
                }, SVMindLogic.$window.on("wolmart_complete", (function() {
                    window.addEventListener("scroll", i, {
                        passive: !0
                    }), SVMindLogic.$window.on("resize", a), setTimeout((function() {
                        a()
                    }), 300)
                })),
                function(i, a) {
                    SVMindLogic.$(i).each((function() {
                        var i = t(this);
                        i.data("sticky-content") || i.data("sticky-content", new e(i, a))
                    }))
                }
        }(), SVMindLogic.parallax = function(e, i) {
            t.fn.themePluginParallax && SVMindLogic.$(e).each((function() {
                var e = t(this);
                e.themePluginParallax(t.extend(!0, SVMindLogic.parseOptions(e.attr("data-parallax-options")), i))
            }))
        }, SVMindLogic.skrollrParallax = function() {
            SVMindLogic.isMobile || "undefined" != typeof skrollr && SVMindLogic.$(".skrollable").length && skrollr.init({
                forceHeight: !1
            })
        }, SVMindLogic.initFloatingParallax = function() {
            t.fn.parallax && SVMindLogic.$(".floating-item").each((function(e) {
                var i = t(this);
                i.data("parallax") && (i.parallax("disable"), i.removeData("parallax"), i.removeData("options")), i.children().addClass("layer").attr("data-depth", i.attr("data-child-depth")), i.parallax(SVMindLogic.parseOptions(i.data("options")))
            }))
        }, SVMindLogic.isotopeOptions = {
        ...
        }, SVMindLogic.isotopes = function(e, i) {
            if ("function" == typeof imagesLoaded && t.fn.isotope) {
                var a = this;
                SVMindLogic.$(e).each((function() {
                    var e = t(this),
                        n = t.extend(!0, {}, a.isotopeOptions, SVMindLogic.parseOptions(e.attr("data-grid-options")), i || {});
                    SVMindLogic.lazyLoad(e), e.imagesLoaded((function() {
                        n.customInitHeight && e.height(e.height()), n.customDelay && SVMindLogic.call((function() {
                            e.isotope(n)
                        }), parseInt(n.customDelay)), e.isotope(n)
                    }))
                }))
            }
        }, SVMindLogic.initNavFilter = function(e) {
            t.fn.isotope && SVMindLogic.$(e).on("click", (function(e) {
                var i = t(this),
                ...
                t(n || ".grid").isotope({
                    ...
                    SVMindLogic.$window.trigger("appear.check")
                })), i.parent().siblings().children().removeClass("active"), i.addClass("active"), e.preventDefault()
            }))
        }, SVMindLogic.ratingTooltip = function(t) {
            for (var e = SVMindLogic.byClass("ratings-full", t || document.body), i = e.length, a = function() {
                    var t = parseInt(this.firstElementChild.style.width.slice(0, -1)) / 20;
                    this.lastElementChild.innerText = t ? t.toFixed(2) : t
                }, n = 0; n < i; ++n) e[n].addEventListener("mouseover", a), e[n].addEventListener("touchstart", a, {
                passive: !0
            })
        }, SVMindLogic.setProgressBar = function(e) {
            SVMindLogic.$(e).each((function() {
                var e = t(this),
        ...
        }, SVMindLogic.alert = function(e) {
            SVMindLogic.$body.on("click", e + " .btn-close", (function(i) {
                i.preventDefault(), t(this).closest(e).fadeOut((function() {
                    t(this).remove()
                }))
            }))
        }, SVMindLogic.closeTopNotice = function(e) {
            SVMindLogic.$body.on("click", e, (function(e) {
                e.preventDefault(), t(".top-banner").slideUp()
            }))
        }, SVMindLogic.accordion = function(e) {
            SVMindLogic.$body.on("click", e, (function(e) {
                var a = t(this),
                    n = a.closest(".card").find(a.attr("href")),
                    o = a.closest(".accordion");
                e.preventDefault(), 0 === o.find(".collapsing").length && 0 === o.find(".expanding").length && (n.hasClass("expanded") ? o.hasClass("radio-type") || i(n) : n.hasClass("collapsed") && (o.find(".expanded").length > 0 ? SVMindLogic.isIE ? i(o.find(".expanded"), (function() {
                    i(n)
        ...
        }, SVMindLogic.animationOptions = {
            name: "fadeIn",
            duration: "1.2s",
            delay: ".2s"
        }, SVMindLogic.appearAnimate = function(e) {
            SVMindLogic.$(e).each((function() {
                var e = this;
                SVMindLogic.appear(e, (function() {
                    if (e.classList.contains("appear-animate")) {
                        var i = t.extend({}, SVMindLogic.animationOptions, SVMindLogic.parseOptions(e.getAttribute("data-animation-options")));
                        setTimeout((function() {
        ...
        }, SVMindLogic.countDown = function(e) {
            t.fn.countdown && SVMindLogic.$(e).each((function() {
                var e = t(this),
                    i = e.data("until"),
                    a = e.data("compact"),
        ...
        }, SVMindLogic.priceSlider = function(e, i) {
            "object" == typeof noUiSlider && SVMindLogic.$(e).each((function() {
                var e = this;
        ...
        }, SVMindLogic.stickySidebarOptions = {
            autoInit: !0,
            minWidth: 991,
            ...
            top: 0,
            bottom: 0
        }, SVMindLogic.stickySidebar = function(e) {
            if (t.fn.themeSticky) {
                var i = 0;

                function a() {
                    SVMindLogic.$(e).trigger("recalc.pin"), t(window).trigger("appear.check")
                    ...
                    var e = t(this);
                    e.themeSticky(t.extend({}, SVMindLogic.stickySidebarOptions, {
                        padding: {
                            top: i
                        }
                    }, SVMindLogic.parseOptions(e.attr("data-sticky-options"))))
                })), setTimeout(a, 300), SVMindLogic.$window.on("click", ".tab .nav-link", (function() {
                    setTimeout(a)
                }))
            }
        }, SVMindLogic.zoomImageOptions = {
            responsive: !0,
            borderSize: 0,
            zoomType: "inner",
            onZoomIn: !0,
            magnify: 1.1
        }, SVMindLogic.zoomImageObjects = [], SVMindLogic.zoomImage = function(e) {
            t.fn.zoom && e && ("string" == typeof e ? t(e) : e).find("img").each((function() {
                var e = t(this);
                SVMindLogic.zoomImageOptions.target = e.parent(), SVMindLogic.zoomImageOptions.url = e.attr("data-zoom-image"), e.zoom(SVMindLogic.zoomImageOptions), SVMindLogic.zoomImageObjects.push(e)
            }))
        }, SVMindLogic.zoomImageOnResize = function() {
            SVMindLogic.zoomImageObjects.forEach((function(e) {
                e.each((function() {
                    var e = t(this).data("zoom");
                    e && e.refresh()
                }))
            }))
        }, SVMindLogic.lazyLoad = function(t, e) {
            function i() {
                this.setAttribute("src", this.getAttribute("data-src")), this.addEventListener("load", (function() {
                    this.style["padding-top"] = "", this.classList.remove("lazy-img")
                }))
            }
            SVMindLogic.$(t).find(".lazy-img").each((function() {
                void 0 !== e && e ? i.call(this) : SVMindLogic.appear(this, i)
            }))
        }, SVMindLogic.initPopup = function(e, i) {
            SVMindLogic.$body.hasClass("home") && "true" !== SVMindLogic.getCookie("hideNewsletterPopup") && setTimeout((function() {
                /*
                SVMindLogic.popup({
                    items: {
                    ...
                    callbacks: {
                        beforeClose: function() {
                            t("#hide-newsletter-popup")[0].checked && SVMindLogic.setCookie("hideNewsletterPopup", !0, 7)
                        }
                    }
                })
                */
            }), 7500), SVMindLogic.$body.on("click", ".btn-iframe", (function(e) {
                e.preventDefault(), SVMindLogic.popup({
                    items: {
            ...
            })), SVMindLogic.$body.on("click", ".sign-in", (function(e) {
                e.preventDefault(), SVMindLogic.popup({
                    items: {
        ...
        }, SVMindLogic.initNotificationAlert = function() {
            SVMindLogic.$body.hasClass("has-notification") && setTimeout((function() {
                SVMindLogic.$body.addClass("show-notification")
            }), 5e3)
        }, SVMindLogic.countTo = function(e) {
            t.fn.countTo && SVMindLogic.$(e).each((function() {
                SVMindLogic.appear(this, (function() {
                    var e = t(this);
                    setTimeout((function() {
                        e.countTo({
                            onComplete: function() {
        ...
        }, SVMindLogic.Minipopup = (i = 0, a = [], n = !1, o = [], s = !1, r = function() {
            if (!n)
                for (var t = 0; t < o.length; ++t)(o[t] -= 200) <= 0 && this.close(t--)
        }, {
            init: function() {
                var i = document.createElement("div");
                i.className = "minipopup-area", SVMindLogic.byClass("page-wrapper")[0].appendChild(i), e = t(i), this.close = this.close.bind(this), r = r.bind(this)
            },
            open: function(n, l) {
                var c, d = this,
                    p = t.extend(!0, {}, SVMindLogic.minipopupOption, n);
                c = t(SVMindLogic.parseTemplate(p.template, p)), d.space = p.space;
                ...
                u.length && u.on("load", (function() {
                    ...
                    })), SVMindLogic.$body.on("touchstart", (function() {
                        d.resume()
        ...
        }), SVMindLogic.headerToggleSearch = function(t) {
            var e = SVMindLogic.$(t);
            SVMindLogic.$body.on("click", ".hs-toggle .search-toggle", (function(t) {
                t.preventDefault()
            })), "ontouchstart" in document ? (e.find(".search-toggle").on("click", (function(t) {
                e.toggleClass("show")
            })), SVMindLogic.$body.on("click", (function(t) {
                e.removeClass("show")
        ...
        }, SVMindLogic.scrollTo = function(e, i) {
            var a = void 0 === i ? 0 : i;
    ...
    function(t) {
        var e = function(t) {
                t.preventDefault(), SVMindLogic.$body.addClass("mmenu-active")
            },
            i = function(t) {
                t.preventDefault(), SVMindLogic.$body.removeClass("mmenu-active")
            },
            a = {
                init: function() {
                ...
                initMenu: function() {
                    ...
                    })), SVMindLogic.$window.on("resize", (function() {
                ...
                initCategoryMenu: function() {
                    ...
                    if (e.length) {
                        ...
                        if (e.hasClass("with-sidebar")) {
                            var n = SVMindLogic.byClass("sidebar");
                            n.length && (e.find(".dropdown-box").css("width", n[0].offsetWidth - 20), SVMindLogic.$window.on("resize", (function() {
                ...
                initMobileMenu: function() {
                    ...
                    })), t(".mobile-menu-toggle").on("click", e), t(".mobile-menu-overlay").on("click", i), t(".mobile-menu-close").on("click", i), SVMindLogic.$window.on("resize", i)
                },
    ...
    function(t) {
        ...
        var i = function(t) {
            ...
            a = function(t) {
                ...
                for (e = 0; e < a; ++e)
                    if (!i[e].classList.contains("active")) {
                        var n, o = SVMindLogic.byClass("appear-animate", i[e]);
            ...
            o = function() {
                ...
                t(this.wrapperEl).find(".swiper-slide-active .slide-animate").each((function() {
                    var i = t(this),
                        a = t.extend(!0, {}, SVMindLogic.animationOptions, SVMindLogic.parseOptions(i.data("animation-options"))),
                        n = a.duration,
                        o = a.delay,
                        s = a.name;
                    setTimeout((function() {
                        ...
                        n = n || "0.75s";
                        var a = SVMindLogic.requestTimeout((function() {
            ...
            r = function(e) {
                ...
                i.translateFlag = 1, i.prev = i.next, a.find(".swiper-slide .slide-animate").each((function() {
                    var e = t(this),
                        i = t.extend(!0, {}, SVMindLogic.animationOptions, SVMindLogic.parseOptions(e.data("animation-options")));
                ...
                if (1 == i.translateFlag) {
                    if (i.next = this.slider.activeIndex, a.find(".show-content").removeClass("show-content"), i.prev != i.next) {
                        if (a.find(".show-content").removeClass("show-content"), a.hasClass("animation-slider")) {
                            for (var n = 0; n < i.timers.length; n++) SVMindLogic.deleteTimeout(i.timers[n]);
                            i.timers = []
                        }
                        a.find(".swiper-slide-active .slide-animate").each((function() {
                            var e = t(this),
                                a = t.extend(!0, {}, SVMindLogic.animationOptions, SVMindLogic.parseOptions(e.data("animation-options"))),
                                n = a.duration,
                                o = a.delay,
                                s = a.name;
                            ...
                            var r = SVMindLogic.requestTimeout((function() {
        ...
        }, SVMindLogic.slider = function(i, a = {}, n = !1) {
            SVMindLogic.$(i).each((function() {
                var i = t(this);
                n ? new e(i, a) : SVMindLogic.call((function() {
                    new e(i, a)
                }))
            }))
        }, SVMindLogic.slider.pgToggle = function() {
    ...
    function(t) {
        ...
        e.prototype.init = function(e) {
            var a = this;
            return a.name = e, a.$sidebar = t("." + e), a.isNavigation = !1, a.$sidebar.length && (a.isNavigation = a.$sidebar.hasClass("sidebar-fixed") && a.$sidebar.parent().hasClass("toolbox-wrap"), a.isNavigation && (i = i.bind(this), SVMindLogic.$window.on("resize", i)), SVMindLogic.$window.on("resize", (function(t) {
                SVMindLogic.windowResized(t.timeStamp) && SVMindLogic.$body.removeClass(e + "-active")
                ...
                SVMindLogic.$body.removeClass(e + "-active"), t.preventDefault()
            }))), !1
            ...
            } else e.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)), SVMindLogic.$body.toggleClass(e.name + "-active").removeClass("closed");
            setTimeout((function() {
                t(window).trigger("appear.check")
            }), 400)
        }, SVMindLogic.sidebar = function(t) {
            return (new e).init(t)
        }
    }(jQuery),
    function(t) {
        var e = {
            init: function() {
                var e;
                SVMindLogic.call(SVMindLogic.ratingTooltip, 500), SVMindLogic.call(SVMindLogic.setProgressBar(".progress-bar"), 500), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), SVMindLogic.$body.on("mousedown", ".select-menu", (function(e) {
                        var i = t(e.currentTarget),
                            a = t(e.target),
                            n = i.hasClass("opened");
                    ...
                    })), SVMindLogic.$body.on("click", ".select-menu a", (function(t) {
                        t.preventDefault()
                    })), SVMindLogic.$body.on("click", ".selected-item i", (function(e) {
                    ...
                    })), SVMindLogic.$body.on("mousedown", (function(e) {
                        t(".select-menu").removeClass("opened")
                    })), SVMindLogic.$body.on("click", ".filter-items a", (function(e) {
                        var i = t(this).closest(".filter-items");
                        i.hasClass("search-ul") || i.parent().hasClass("select-menu") || (t(this).parent().toggleClass("active"), e.preventDefault())
                    })), SVMindLogic.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", (function(e) {
                        e.preventDefault();
                        var i = t(this);
                        i.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function() {
                            i.removeClass("load-more-overlay loading"), i.toggleClass("w-icon-cart").toggleClass("w-icon-cart")
                        }), 500)
                        /*
                        var i = t(this),
                        ...
                        i.hasClass("disabled") ? alert("Please select some product options before adding this product to your cart.") : (i.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function() {
                            i.removeClass("load-more-overlay loading"), SVMindLogic.Minipopup.open({
                        ...
                        */
                    })), SVMindLogic.$body.on("click", ".product:not(.product-single) .btn-wishlist", (function(e) {
                        e.preventDefault();
                        var i = t(this);
                        i.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function() {
                            i.removeClass("load-more-overlay loading"), i.toggleClass("w-icon-heart").toggleClass("w-icon-heart-full")
                        }), 500)
                    })), (e = t(".product-popup")).length && SVMindLogic.$body.on("click", ".btn-quickview", (function(i) {
                        i.preventDefault(), SVMindLogic.popup({
                            items: {
                                src: e[0].outerHTML
                            },
                            callbacks: {
                                open: function() {
                                    SVMindLogic.productSingle(t(".mfp-product .product-single"))
                                },
                                close: function() {
                    ...
                    function() {
                        ...
                        a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append(''), a = t(".page-wrapper > .compare-popup")), SVMindLogic.$body.on("click", ".product .btn-compare", (function(o) {
                            var s = t(this);
                        ...
                        })), SVMindLogic.$body.on("click", ".compare-popup-overlay", (function() {
                            a.removeClass("show")
                        }))
                    }(), SVMindLogic.priceSlider(".filter-price-slider")
            },
                    ...
                    window.pageYOffset > i + a.outerHeight() - window.innerHeight - 150 && "loading" != a.data("load-state") && t.ajax({
                        ...
                        success: function(e) {
                            ...
                            a.data("load-state", "loading"), a.next().hasClass("load-more-overlay") ? a.next().addClass("loading") : t('<div class="mt-4 mb-4 load-more-overlay loading"></div>').insertAfter(a), setTimeout((function() {
                                ...
                                }), 200), a.data("load-state", "loaded"), SVMindLogic.countDown(i.find(".product-countdown"))
                            }), 500);
    ...
    function(t) {
        ...
        e.min = 1, e.max = 1e6, e.value = 1, e.prototype.init = function(t) {
            ...
            })).on("mouseup", i.stop), SVMindLogic.$body.on("mouseup", i.stop).on("touchend", i.stop).on("touchcancel", i.stop)
        }, e.prototype.startIncrease = function(t) {
            t && t.preventDefault();
            var e = this;
            e.value = e.$value.val(), e.value < e.max && e.$value.val(++e.value), e.increaseTimer = SVMindLogic.requestTimeout((function() {
                e.speed = 1, e.increaseTimer = SVMindLogic.requestInterval((function() {
            ...
            t && t.preventDefault();
            var e = this;
            e.value = e.$value.val(), e.value > e.min && e.$value.val(--e.value), e.decreaseTimer = SVMindLogic.requestTimeout((function() {
                e.speed = 1, e.decreaseTimer = SVMindLogic.requestInterval((function() {
                    e.$value.val(e.value = Math.max(e.value - Math.floor(e.speed *= 1.05), e.min))
                }), 50)
            }), 400)
        }, e.prototype.stop = function(t) {
            SVMindLogic.deleteTimeout(this.increaseTimer), SVMindLogic.deleteTimeout(this.decreaseTimer)
        }, SVMindLogic.initQtyInput = function(i) {
            SVMindLogic.$(i).each((function() {
                var i = t(this);
    ...
    function(t) {
        ...
        e.defaults = {
            ...
            n.isOpen ? n.content ? setTimeout((function() {
                SVMindLogic.popup(i, a)
            }), 5e3) : t.magnificPopup.close() : t.magnificPopup.open(t.extend(!0, {}, e.defaults, a ? e.presets[a] : {}, i)), SVMindLogic.$body.on("mousedown", ".mfp-wrap", o), "ontouchstart" in document && document.addEventListener("touchstart", o, {
                passive: !0
            })
        }, SVMindLogic.popup = function(t, i) {
            return new e(t, i)
        }
    }(jQuery),
    function(t) {
        ...
        var i = function() {
            ...
            n = function(e) {
                e.preventDefault(), SVMindLogic.scrollTo(t('.product-tabs > .nav a[href="' + this.getAttribute("href") + '"]').trigger("click"))
            };
        e.prototype.init = function(e) {
            var o = this,
                s = e.find(".product-single-swiper");
            o.$wrapper = e, o.isQuickView = !!e.closest(".mfp-content").length, o._isPgVertical = !1, o.isQuickView && (i = i.bind(this), SVMindLogic.ratingTooltip()),
                function(t) {
                    t.$thumbs = t.$wrapper.find(".product-thumbs"), t.$thumbsWrap = t.$thumbs.parent(), t.$thumbUp = t.$thumbsWrap.find(".thumb-up"), t.$thumbDown = t.$thumbsWrap.find(".thumb-down"), t.$thumbsDots = t.$thumbs.children(), t.thumbsCount = t.$thumbsDots.length, t.$productThumb = t.$thumbsDots.eq(0), t._isPgVertical = t.$thumbsWrap.parent().hasClass("product-gallery-vertical"), t.thumbsIsVertical = t._isPgVertical && window.innerWidth >= 992, SVMindLogic.slider(t.$thumbsWrap, {}, !0)
                }(o), document.body.classList.contains("home") || s.parent().hasClass("product-gallery-video") && (o.isQuickView || s.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'), o.isQuickView || s.append('<a href="#" class="product-gallery-btn product-video-viewer" title="Product Video Thumbnail"><i class="w-icon-movie"></i></a>')), o.$wrapper.on("click", ".btn-wishlist", a), o.$wrapper.on("click", ".rating-reviews", n), "complete" === SVMindLogic.status && (SVMindLogic.slider(s, {
                    thumbs: {
                        swiper: o.$thumbsWrap.data("slider")
                    }
                }), SVMindLogic.initQtyInput(e.find(".quantity"))), s.length && window.addEventListener("resize", (function() {
                    SVMindLogic.requestTimeout((function() {
                    ...
                    t(e.target).find(".product-image").zoom(SVMindLogic.zoomImageOptions)
            ...
            var t = this;
            t.$priceWrap.find("span").text("Rs. 225")/*("$" + (Math.round(50 * Math.random()) + 200) + ".00")*/, t.$priceWrap.slideDown(), t.$clean.slideDown(), t.$btnCart.removeClass("disabled")
            ...
            o.length && (o = o.offset().top + 10, SVMindLogic.scrollTo(o, 500)), setTimeout((function() {
                i.isStickyScrolling = !1
            }), 300)
        }, e.prototype.scrollStickyThumbnail = function() {
            var e = this;
            this.isStickyScrolling || e.$wrapper.find(".product-image-wrapper .product-image").each((function() {
                if (SVMindLogic.isOnScreen(this)) return e.$wrapper.find(".product-thumbs > :nth-child(" + (t(this).index() + 1) + ")").addClass("active").siblings().removeClass("active"), !1
            }))
        ...
        }, SVMindLogic.productSingle = function(i) {
            return SVMindLogic.$(i).each((function() {
                var i = t(this);
    ...
    function(t) {
        function e(e) {
            ...
            if ((i = n.closest(".review-image").length ? n.closest(".review-image").find("img") : o.find(".product-single-swiper").length ? o.find(".product-single-swiper .swiper-slide:not(.cloned) img:first-child") : o.find(".product-gallery-carousel").length ? o.find(".product-gallery-carousel .swiper-slide:not(.cloned) img") : o.find(".product-image img:first-child")).length) {
                ...
                if ("undefined" != typeof PhotoSwipe) {
                    var c = t(".pswp")[0];
                    if ("rtl" == SVMindLogic.$body.attr("dir")) var d = new PhotoSwipe(c, PhotoSwipeUI_Default, a, {
                        index: l,
                        closeOnScroll: !1,
                    ...
                    d.init(), SVMindLogic.photoSwipe = d
                }
            }
        }

        function i(t) {
            t.preventDefault(), SVMindLogic.popup({
                items: {
        ...
        SVMindLogic.initProductSinglePage = function() {
            t(".product-gallery").each((function() {
                    var e = t(this),
                        i = e.find(".product-image");
                    i.length && 0 == e.find(".swiper-container").length && i.zoom(SVMindLogic.zoomImageOptions)
                })),
                function(e) {
                    var i = t(e),
                ...
                }(".product-sticky-content"), document.body.classList.contains("home") || SVMindLogic.$body.on("click", ".product-image-full", e).on("click", ".review-image img", e).on("click", ".product-video-viewer", i).on("click", ".product-degree-viewer", (function(e) {
    ...
    function(t) {
        SVMindLogic.initCodePopup = function() {
            ...
            })), SVMindLogic.$body.on("click", ".box-btn.showcode", (function() {
                var e = t(this);
            ...
            })), SVMindLogic.$body.on("click", ".show-code", (function(e) {
                e.stopPropagation();
                var i = t(this).parent();
                if (i.hasClass("show-code-added")) {
                    var a = i[0].lastElementChild;
                    i[0].removeChild(a), t(".code-popup #textareaCode").text(i.data("codepopup")), t(".code-copy a").html('<i class="copy-icon far fa-copy"></i>Copy to Clipboard'), SVMindLogic.$body.on("click", ".code-copy a", (function(e) {
            ...
            })), SVMindLogic.$body.on("mouseenter mouseleave", ".show-code-action", (function(t) {
                t.stopPropagation()
            }))
        }
    }(jQuery),
    function(t) {
        ...
        e.defaultOptions = {
            ...
            var o = this;
            o.element = a, o.settings = t.extend({}, !0, e.defaultOptions, SVMindLogic.parseOptions(a.attr("data-calendar-options")), n), o.today = new Date, i = i.bind(this);
        ...
        }, SVMindLogic.calendar = function(i, a) {
            SVMindLogic.$(i).each((function() {
                var i = t(this);
                SVMindLogic.call((function() {
                    new e(i, a)
                }))
            }))
        }, SVMindLogic.initVendor = function(e) {
            var i = t(e),
        ...
        }, SVMindLogic.slideContent = function(e) {
            var i = t(e),
                a = i.next();
        ...
        }, SVMindLogic.initLoginVendor = function(e) {
            var i = t(e),
    ...
    }(jQuery), jQuery, SVMindLogic.initLayout = function() {
        SVMindLogic.isotopes(".grid:not(.grid-float)"), SVMindLogic.stickySidebar(".sticky-sidebar")
    }, SVMindLogic.init = function() {
        SVMindLogic.appearAnimate(".appear-animate"), SVMindLogic.setTab(".nav-tabs"), SVMindLogic.stickyContent(".sticky-header", {
            scrollMode: !1
        }), /*SVMindLogic.stickyContent(".sticky-footer", {
            minWidth: 0,
            maxWidth: 767,
            top: 150,
            hide: !0,
            max_index: 2100,
            scrollMode: !0
        }),*/ SVMindLogic.stickyContent(".sticky-toolbox", SVMindLogic.stickyToolboxOptions), SVMindLogic.stickyContent(".product-sticky-content", SVMindLogic.stickyProductOptions), SVMindLogic.parallax(".parallax"), SVMindLogic.skrollrParallax(), SVMindLogic.initFloatingParallax(), SVMindLogic.menu.init(), SVMindLogic.initScrollTopButton(), SVMindLogic.shop.init(), SVMindLogic.alert(".alert"), SVMindLogic.closeTopNotice(".banner-close"), SVMindLogic.accordion(".card-header > a"), SVMindLogic.sidebar("sidebar"), SVMindLogic.sidebar("right-sidebar"), SVMindLogic.productSingle(".product-single"), SVMindLogic.initProductSinglePage(), SVMindLogic.initQtyInput(".quantity"), SVMindLogic.initNavFilter(".nav-filters .nav-filter"), SVMindLogic.calendar(".calendar-container"), SVMindLogic.countDown(".product-countdown, .countdown"), SVMindLogic.initPopup(), SVMindLogic.initNotificationAlert(), SVMindLogic.countTo(".count-to"), SVMindLogic.initCartAction(".cart-offcanvas .cart-toggle"), SVMindLogic.Minipopup.init(), SVMindLogic.headerToggleSearch(".hs-toggle"), SVMindLogic.initVendor(".store"), SVMindLogic.slideContent(".login-toggle"), SVMindLogic.slideContent(".coupon-toggle"), SVMindLogic.slideContent(".checkbox-toggle"), SVMindLogic.initLoginVendor(".user-checkbox"), SVMindLogic.initCodePopup(), SVMindLogic.slider(".swiper-container"), SVMindLogic.call(SVMindLogic.slider.pgToggle), SVMindLogic.$window.on("resize", (function() {
            SVMindLogic.call(SVMindLogic.slider.pgToggle)
        }))
    }, jQuery, window.onload = function() {
        SVMindLogic.canvasWidth = window.innerWidth, SVMindLogic.resizeTimeStamp = 0, SVMindLogic.resizeChanged = !1, SVMindLogic.status = "loaded", document.body.classList.add("loaded"), SVMindLogic.call(SVMindLogic.initLayout), SVMindLogic.call(SVMindLogic.init), SVMindLogic.status = "complete", SVMindLogic.$window.trigger("wolmart_complete")
    };
...
$(document).on('submit', '.form-submit-event2', function (e) {
    e.preventDefault();
