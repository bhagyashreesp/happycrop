...
if(document.getElementById('ecommerceChartView2')) {
    $.ajax({
        url: base_url + from + '/home/fetch_orders_count',
        type: 'GET',
        dataType: 'json',
        success: function (result) {
            $(window).on,
                function (e, t, a) {
                    ...
                    n = function (e, t, a) {
                        ...
                        h = {
                            ...
                            switch ((e || a("#ecommerceChartView2 .chart-action").find(".active")).attr("href")) {
                                case "#scoreLineToDay2":
                                    n("scoreLineToDay2", s, i);
                                    break;
                                case "#scoreLineToWeek2":
                                    n("scoreLineToWeek2", o, r);
                                    break;
                                case "#scoreLineToMonth2":
                                    n("scoreLineToMonth2", l, h)
                            }
                        })(), a(".chart-action li a").on("click", (function () {
                            c(a(this))
                        }))
...
function queryParams(p) {
    return {
        ...
        offset: p.offset,
        search: p.search,
        search_field: ($("#search_field").length) ? $("#search_field").val() : ''
    };
}
...
function insect_pest_query_params(p) {
    return {
        "category_id": $('#category_id').val(),
        limit: p.limit,
        sort: p.sort,
...
function getInsectPests(sub_category_id, target_select)
{
    $.ajax({
        data: {sub_category_id:sub_category_id},
        type: 'POST',
        url: base_url + 'seller/product/getInsectPests',
        dataType: 'json',
        success: function (response) {
            if (response.error == false) {
                $("#"+target_select).html(response.insect_pests);
...
function getSpecifications(formulation_id)
{
    ...
    $.ajax({
        data: {prod_id: prod_id, super_category_id: super_category_id, formulation_id:formulation_id},
        type: 'POST',
        ...
        success: function (response) {
            ...
            CKEDITOR.replace( 'pro_input_specifications' );   
        }
    });
}
...
$(document).on('click', '.update_active_status', function () {
    ...
    if(status == 0)
    {
        message_text = 'Do you want to activate the product?';
        btn_text = 'Yes, Activate!';
    }
    else if(status == 1)
    {
        message_text = 'Do you want to deactivate the product?';
    ...
    {
        message_text = 'Do you want to reject the product?';
        btn_text = 'Yes, Reject!';
    }
...
$(document).on('click', '.update_stock_status', function () {

    var update_id = $(this).data('id');
    var product_stock_status = $(this).data('stock-status');
    var table = $(this).data('table');
    ...
    {
        message_text = 'Is product Out of Stock?';
        btn_text = 'Yes, Out of Stock!';
    }
    else
    {
        message_text = 'Is product in Stock?';
        btn_text = 'Yes, In Stock!';
    }
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                update_product_stock_status(update_id, product_stock_status, table, from);
                swal.close();
            });
        },
        allowOutsideClick: false
...
function update_product_stock_status(update_id, product_stock_status, table, user) {
    $.ajax({
        type: 'GET',
        url: base_url + user + '/home/update_product_stock_status',
        data: { id: update_id, product_stock_status: product_stock_status, table: table },
        dataType: 'json',
        success: function (result) {
            if (result['error'] == true) {
                iziToast.success({
                    message: '<span style="text-transform:capitalize">' + result.message + '</span> Stock Status Updated',
                });
                $('.table').bootstrapTable('refresh');
            } else {
                iziToast.error({
                    message: '<span style="text-transform:capitalize">' + result.message + '</span> Stock Status Not Updated',
                });
            }
        }
    });
...
$(document).on('click', '.delete-category_block', function () {
    var cat_id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure!',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/category_blocks/delete_category_block',
                    data: { id: cat_id },
                    dataType: 'json'
                })
                    .done(function (response, textStatus) {
...
$(document).on('click', '.delete-megamenu_block', function () {
    var cat_id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure!',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/megamenu_blocks/delete_megamenu_block',
                    data: { id: cat_id },
                    dataType: 'json'
                })
                    .done(function (response, textStatus) {
...
$('#send_complaint_msg_form').on('submit', function (e) {
    e.preventDefault();
    var formdata = new FormData(this);
    formdata.append(csrfName, csrfHash);
    ...
    $.ajax({
        ...
        data: formdata,
        beforeSend: function () {
            $('#submit_complaint_msg_btn').html('Please Wait..').attr('disabled', true);
        },
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function (result) {
            csrfHash = result.csrfHash;
            $('#submit_complaint_msg_btn').html('Send').attr('disabled', false);
            if (result.error == false) {
                iziToast.success({
                    message: '<span style="text-transform:capitalize">' + result.message + '</span> ',
                });
...
$('#send_statement_form').on('submit', function (e) {
    e.preventDefault();
    var formdata = new FormData(this);
    formdata.append(csrfName, csrfHash);
    ...
    $.ajax({
        ...
        data: formdata,
        beforeSend: function () {
            $('#submit_statement_btn').html('Please Wait..').attr('disabled', true);
        },
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function (result) {
            csrfHash = result.csrfHash;
            $('#submit_statement_btn').html('Send').attr('disabled', false);
            if (result.error == false) {
                iziToast.success({
                    message: '<span style="text-transform:capitalize">' + result.message + '</span> ',
                });
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result['error'] == true) {
                ...
                submit_btn.html(button_text);
                submit_btn.attr('disabled', false);
                if($(".ed_btn").length && $(".canc_btn").length)
                {
                    $(".canc_btn").click();
                }
...
$(document).ready(function (){
    $('.ed_btn').on('click', function (e) {
        e.preventDefault();
        $('.ed_btn').hide();
        $('.basic-details-form').removeClass('not-editable');
   }); 
   
   $('.canc_btn').on('click', function (e) {
        e.preventDefault();
        $('.basic-details-form').addClass('not-editable');
        $('.ed_btn').show();
   }); 
});
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/webinars/delete_webinar',
                    data: { id: webinar_id },
                    dataType: 'json'
                })
                    .done(function (response, textStatus) {
...
$(document).on('click', '.edit_mfg_exp_batch', function (e, rows) {
    e.preventDefault();
    
    var order_item_id   = $(this).data("order_item_id");
    var order_id        = $(this).data("order_id");
    var mfg_date        = $(this).data("mfg_date");
    var exp_date        = $(this).data("exp_date");
    var batch_no        = $(this).data("batch_no");
    
    var url = $(this).data("url");
    
    $('#edit_mfg_exp_batch_form #order_item_id').val(order_item_id);
    $('#edit_mfg_exp_batch_form #order_id').val(order_id);
    $('#edit_mfg_exp_batch_form #mfg_date').val(mfg_date);
    $('#edit_mfg_exp_batch_form #exp_date').val(exp_date);
    $('#edit_mfg_exp_batch_form #batch_no').val(batch_no); 
});

$('#edit_mfg_exp_batch_form').on('submit', function (e) {
    e.preventDefault();
    var formdata = new FormData(this);
    formdata.append(csrfName, csrfHash);
    ...
    $.ajax({
        ...
        data: formdata,
        beforeSend: function () {
            $('#edit_mfg_exp_batch_form #submit_btn').html('Please Wait..').attr('disabled', true);
        },
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function (result) {
            csrfHash = result.csrfHash;
            $('#edit_mfg_exp_batch_form #submit_btn').html('Update').attr('disabled', false);
            if(result.error == false) {
                iziToast.success({
                    message: '<span style="text-transform:capitalize">' + result.message + '</span> ',
                });
