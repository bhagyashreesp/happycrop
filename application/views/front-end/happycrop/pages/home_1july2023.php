                        ...
                        <ul class="navbar-nav">
                            ...
                            foreach ($megamenu_blocks as $count_key => $row) 
                            {
                                ...
                                <li>
                                    ...
                                    {
                                        ?>
                                        <a class="menu-link chemical-fertilizers-icon--" href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>">
                                            <figure>
                                    ...
                                    {
                                        ?>
                                        <a class="menu-link chemical-fertilizers-icon--" href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>">
                                            <figure>
                                                <img class="small_thumb" src="<?php echo base_url().$row['image']; ?>" alt="<?php echo $row['title'];?>" />
                                            </figure>
                                            <?php echo $row['title'];?>
                                    ...
                                    if($subcategories)
                                    {
                                        ...
                                        foreach($subcategories as $subcategory)
                                        {
                                            ...
                                            <div class="sub-menu-item">
                                                ...
                                                {
                                                    ?>
                                                    <h4 class="menu-title"><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h4>
                                                    <?php
                                                }
                                                else if($row['show_type'] == 2)
                                                {
                                                    ?>
                                                    <h4 class="menu-title"><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h4>
                                                    <?php
                                                }
                                                ?>
                                                <ul>
                                                    ...
                                                    if(!empty($subcategory['sub_categories']))
                                                    {
                                                        ...
                                                        if($row['show_type'] == 1)
                                                        {
                                                            ...
                                                            ?>
                                                            <li><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>">View More</a></li>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ...
                                                            ?>
                                                            <li><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>">View More</a></li>
                                                            <?php
                                                        }
                                                    }
                                                    else
    ...
    if($category_blocks)
    {
        ...
        foreach ($category_blocks as $count_key => $row) {
                ...
                <div class="container d-xs-show  d-lg-show">
                    <div class="product-wrapper-1 custom-product-wrapper-1 appear-animate mb-5">
                        <div class="title-link-wrapper pb-1 mt-2 mb-2">
                            ...
                            {
                                ?>
                                <h2 class="title ls-normal mb-0"><a href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?></a></h2>
                                <?php
                            }
                            else if($row['show_type'] == 2)
                            {
                                ?>
                                <h2 class="title ls-normal mb-0"><a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?></a></h2>
                                <?php  
                            }
                            ?>
                        </div>
                                            ...
                                            <article class="post post-mask overlay-zoom br-sm">
                                                ...
                                                else 
                                                {
                                                    ...
                                                    <figure class="post-media">
                                                        ...
                                                        {
                                                            ?>
                                                            <a href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>">
                                                        ...
                                                        {
                                                            ?>
                                                            <a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>">
                                                                <img src="<?php echo $row['banner'] ?>" alt="<?= $row['name'] ?>" />
                                                            </a>
                                                            <?php  
                                                        }
                                                    ...
                                                    <div class="post-details">
                                                        <div class="post-details-visible">
                                                            <div class="text-left">
                                                                ...
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>"><?= $row['name'] ?></a></h4>
                                                                    <a href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>" class="btn btn-white btn-rounded btn-sm">View All</a>
                                                                    <?php
                                                                }
                                                                else if($row['show_type'] == 2)
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?><?php //echo $row['name'] ?></a></h4>
                                                                    <a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>" class="btn btn-white btn-rounded btn-sm">View All</a>
                                                                    <?php  
                                                                }
                                                                ?>
                                                            </div>
                                            ...
                                            <div class="box height_210">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>"><?php echo ucwords(strtolower($subcategory['name']));?></a></h6>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>"><?php echo ucwords(strtolower($subcategory['name']));?></a></h6>
                                                            <?php
                                                        }  
                                                        ?>
            ...
            <section class="color-accordion-section bg-light-green--">
                <div class="container d-lg-none pt-3 pb-3 ">
                    <div class="row">
                        <div class="col-8">
                            <h2 class="title mb-5"><?= ucfirst($row['title']) ?></h2>
                        </div>
                        <div class="col-4 text-center">
                            ...
                            {
                                ?>
                                <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm btn-sm-view-more">View All</a>
                                <?php
                            }
                            else if($row['show_type'] == 2)
                            {
                                ?>
                                <a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm btn-sm-view-more">View All</a>
                                <?php
                            }  
                            ?>
                        </div>
                                                        ...
                                                        <div class="col-12 ">
                                                            <ul class="widget-body row card-menu">
                                                                ...
                                                                if(!empty($subcategory['sub_categories']))
                                                                {
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <li class="col-4- col-12"><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>" title="View More"><span class="text-primary">View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                        <?php
                                                                    }
                                                                    else if($row['show_type'] == 2)
                                                                    {
                                                                        ?>
                                                                        <li class="col-4- col-12"><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>" title="View More"><span class="text-primary">View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                        <?php
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    if($sub_products)
                                                                    {
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>" title="View More" class="text-primary"><span>View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 2)
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>" title="View More" class="text-primary"><span>View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                                }
