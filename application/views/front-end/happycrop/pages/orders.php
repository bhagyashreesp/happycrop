            ...
            <div class="col-md-10 col-12">
                ...
                <div class="card content-area border-none p-4">
                    <div class="card-innr">
                        ...
                        <?php if(!$condition) { ?>
                            <style>.dash-bg-gray {background-color: rgba(0,0,0,.15) !important;}</style>
                            <div class="card content-area border-none pl-2 pr-2">
                                <div class="card-innr">
                                    <div class="gaps-1-5x row d-flex adjust-items-center mb-3 dash-bg-gray">
                                        <div class="col-md-12">
                                            <h5 class="mt-2 mb-0 text-dark">Order Outlines</h5>
                                            <div class="row mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select id="order_status" name="order_status" placeholder="Select Status" required="" class="form-control">
                                                ...
                                                <?php */ ?>
                                                <option value="payment_demand">Payment request received.</option>
                                                <option value="payment_ack">Transaction details shared.</option>
                                                ...
                                                <option value="issue_closed">Order closed</option>
