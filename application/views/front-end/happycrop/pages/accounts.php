                ...
                <div class="">
                    <ul class="nav prof-nav">
                        <li class="nav-item active">
                            <a href="<?php echo base_url('my-account/accounts/') ?>" class="nav-link2 btn btn-primary text-white mr-2">Invoices</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('my-account/statements/') ?>" class="nav-link2 btn">Statements</a>
                        </li>
                       </li>
                    </ul>
                </div>
