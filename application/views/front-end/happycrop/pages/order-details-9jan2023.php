                                                    ...
                                                    { 
                                                        if($manufacture['seller_id'] == $item['seller_id'])
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?php echo $item['packing_size'].' '.$item['unit']; echo ($item['carton_qty'] > 1) ? ' &#x2715; '.$item['carton_qty'] : ''; ?></td>
                                                                <td class="text-center"><?php echo $item['minimum_order_quantity']; ?></td>
                                            ...
                                            <div class="tmln-outer">
                                                ...
                                                if($order_item_stages)
                                                {
                                                        ...
                                                        <div class="tmln-card">
                                                          <div class="tmln-info">
                                                            ...
                                                            <?php } else if($order_item_stage['status']=='delivered') { ?> 
                                                                <h3 class="tmln-title">Your order delivered by manufacturer. <small class="float-right font-weight-normal"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3>
                                                    ...
                                                    if($order_item_stage['active_status'] == 'received' || count($order_item_stages) == 0)
                                                    {
                                                        ...
                                                        <div class="tmln-card in-active">
                                                            <div class="tmln-info">
                                                                <h3 class="tmln-title">Your order delivered by manufacturer. <small class="float-right font-weight-normal">XXX XX XXX XXXX XX:XX XX</small></h3>
                                                            </div>
                                                        </div>
                                                        <?php
                                                    }
