<!-- breadcrumb -->
<style>.table-resp tr:last-child{display: block;}</style>
            ...
            <div class="col-md-9 col-12">
                <div class='card border-0'>
                    <div class="card-header bg-white">
                        <h3 class="float-left">Storage Addresses</h3>
                        <div class="card-tools">
                            <a class="btn btn-primary btn-sm text-white text-center float-right" href="javascript:void(0);" onclick="AjaxModal('<?php echo base_url('my-account/modal_add_address');?>','Add Address');">Add Address</a>
                        </div>
                    </div>
                    <?php /* ?>
                    ...
                    <div class="card-body p-1">
                        <table id="address_list_table" class='table-striped ' data-toggle="table" data-url="<?= base_url('my-account/get-address-list/'.$type) ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                            <thead>
                                <tr>
                                    <!--<th data-field="id" data-sortable="true">ID</th>-->
                                    <th data-field="shop_name" data-sortable="false"><?=!empty($this->lang->line('shop_name')) ? $this->lang->line('shop_name') : 'Shop Name'?></th>
                                    <th data-field="plot_no" data-sortable="false">Plot No. / Floor / Building</th> 
                                    <th data-field="street_locality" data-sortable="false">Street / Locality / Village</th>
                                    ...
                                    <th data-field="district_name" data-sortable="false">District</th>
                                    ...
                                    <th data-field="action" data-events="editAddress" data-sortable="false"><?=!empty($this->lang->line('action')) ? $this->lang->line('action') : 'Action'?></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
