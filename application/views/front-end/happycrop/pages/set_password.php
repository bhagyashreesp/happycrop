                    ...
                    <div class="login-popup border-radius-10 bg-white">
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            <ul class="nav nav-tabs text-uppercase" role="tablist">
                                <li class="nav-item">
                                    <a href="#sign-in" class="nav-link border-none active">Set Password</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-in">
                                    ...
                                    <?php } ?>
                                    <form id="sign-in-form" name="sign-in-form" action="<?php echo base_url('register/set-password2/'. $code) ?>" class='form-submit-event3' method="post">
