        ...
        if($seller_info)
        {
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <p>
                        <?php
                        echo $seller_info['plot_no'].', '.$seller_info['street_locality'],', '.$seller_info['landmark'],', '.$seller_info['city_name'].', '.$seller_info['state_name'].' '.$seller_info['pin'];
                        ?>
                    </p>
                </div>
                <div class="col-md-2">
                    ...
                    {
                        ?>
                        <p><i class="fa fa-check-circle text-success"></i> GST<br />
                        <?php
                        echo $seller_info['gst_no'];
                        ?>
                        </p>
                        <?php
                    }
