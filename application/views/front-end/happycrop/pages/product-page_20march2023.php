<style>.variation_pro_select {width: 75px;}.num-block {float: left;margin-right: 10px;}.current_active {background: #ECFFA8;}</style>
<?php $total_images = 0; ?>
<!-- breadcrumb -->
    ...
    <div class="product product-single row  justify-content-md-center">
        <div class="col-md-10">
            <div class="row">
                ...
                <div class="col-md-7 mb-6 mb-md-8">
                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="product-bm-wrapper">
                                    ...
                                    <div class="product-meta">
                                        ...
                                        <div class="product-categories">
                                            Company / Manufacture:
                                            <span class="product-category"><a href="#"><?= ucfirst($product['product'][0]['company_name']) ?></a></span>
                                        </div>
                                        <!--
                        ...
                        <h5 class="mb-1 font-weight-normal">Country of Origin: <?= $product['product'][0]['made_in'] ?></h5>
                        ...
                        <div class="product-price2">
                            ...
                            <?php } else { ?>
                                <p class="mb-0 mt-2 price">
                                    <h4 class="mb-1">Price per piece –</h4>
                                    <span id="mrp" class="mr-2 mb-1">
                                        MRP: <?php echo $product['product'][0]['variants'][0]['mrp_per_item']; ?>
                                    </span>
                                    <span id="price" class="mr-2 mb-1">
                                        Standard Price: <?php echo $product['product'][0]['variants'][0]['price_per_item']; ?>
                                        <?php 
                                        //$price = get_price_range_of_product($product['product'][0]['id']);
                                        //echo $price['range'];
                                        ?>
                                    </span>
                                    <span id="special_price" class="mr-2 mb-1">
                                        Discounted Price: <?php echo $product['product'][0]['variants'][0]['special_price_per_item']; ?>
                                    </span>
                                    <div class="clearfix"></div>
                                    <span id="you_save" class="mr-2 mb-1">
                                        You Save: <?php echo $product['product'][0]['variants'][0]['price_per_item'] - $product['product'][0]['variants'][0]['special_price_per_item']; ?>
                                    </span>
                                    <span id="discount" class="mr-2 mb-1">
                                        Discount: <?php echo round((($product['product'][0]['variants'][0]['price_per_item'] - $product['product'][0]['variants'][0]['special_price_per_item'])/$product['product'][0]['variants'][0]['price_per_item'] *100), 2); ?>%
                                    </span>
                                    <div class="clearfix"></div>
                                    <span id="discounted_price" class="mr-2 h3 mb-1">
                                    Discounted Price: <?php echo $product['product'][0]['variants'][0]['special_price']*1; ?>
                                    </span>
                                    <div class="clearfix"></div>
                                    <span id="you_save_price" class="mr-2 h3 mb-1">
                                    You Save: <?php echo $product['product'][0]['variants'][0]['price']-$product['product'][0]['variants'][0]['special_price']; ?>
                                    </span>
                                    <?php /* ?>
                                    <sup>
                        ...
                        <?php
                        if($product['product'][0]['type'] == "carton_product" && !empty($product['product'][0]['variants']))
                        {
                            ?>
                            <style>
                            .hc-table{border-spacing: 5px;border-collapse: separate;border: none medium;}
                            .hc-table th, .hc-table td{border: none medium;}
                            .hc-table .bg-thead{background: #ffe699;border: none medium;font-weight: 600;font-size: 11px;}
                            ...
                            .hc-table .current_active, .hc-table .current_active .btn-primary{background: #3c78b4;border: none medium;}
                            </style>
                            <h4 class="h4">Carton Details</h4>
                            <table class="table table-bordered mt-2 hc-table" cellspacing="5">
                                <thead>
                                    <tr class="bg-thead">
                                        <th class="text-center">Size</th>
                                        <th class="text-center">Weight</th>
                                        <th class="text-center" width="15%">MRP</th>
                                        <th class="text-center" width="15%">STD Price</th>
                                        <th class="text-center" width="15%">DISC Price</th>
            ...
            <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="product-tab-about-company">
                        <div class="row">
                            <div class="col-12">
                                <?= (isset($product['product'][0]['about_company']) && !empty($product['product'][0]['about_company'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product['product'][0]['about_company'])) : ""  ?>
                            </div>
                        </div>
                    </div>
