                                            ...
                                            <div class="box height_210">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h6>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h6>
                                                            <?php
                                                        }  
                                                        ?>
                ...
                <div class="container d-lg-none pt-3 pb-3 ">
                    <div class="row">
                        ...
                        <div class="col-4 text-center">
                            ...
                            {
                                ?>
                                <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm">View All</a>
                                <?php
                            }
                            else if($row['show_type'] == 2)
                            {
                                ?>
                                <a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm">View All</a>
                                <?php
                            }  
                            ?>
                        </div>
                                        ...
                                        foreach($subcategories as $subcategory)
                                        {
                                            ...
                                            <div class="card bg-white">
                                                <div class="card-header">
                                                    <a href="#collapse<?php echo $subcategory['id'];?>" class="<?php echo $expand;?> bg-white"><?php echo $subcategory['name'];?></a>
                                                </div>
                                                <div class="card-body <?php echo $collapse;?>" id="collapse<?php echo $subcategory['id'];?>">
                                                    <div class="row">
                                                        ...
                                                        <?php */ ?>
                                                        <div class="col-12 ">
                                                            <ul class="widget-body card-menu">
                                                                <?php
                                                                if(!empty($subcategory['sub_categories']))
                                                                {
                                                                    $sub_cats = $subcategory['sub_categories'];
                                                                    foreach($sub_cats as $sub_cat)
                                                                    {
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li><a href="<?php echo base_url('products/category/' . html_escape($sub_cat['slug'])) ?>"><?php echo $sub_cat['name'] ?> <i class="w-icon-angle-right pull-right"></i></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 2)
                                                                        {
                                                                            ?>
                                                                            <li><a href="<?php echo base_url('products/insect_pests/' . html_escape($sub_cat['slug'])) ?>"><?php echo $sub_cat['name'] ?> <i class="w-icon-angle-right pull-right"></i></a></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <li><a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>">View More <i class="w-icon-angle-right pull-right"></i></a></li>
                                                                        <?php
                                                                    }
                                                                    else if($row['show_type'] == 2)
                                                                    {
                                                                        ?>
                                                                        <li><a href="<?php echo base_url('products/insect_pests/' . html_escape($subcategory['slug'])) ?>">View More <i class="w-icon-angle-right pull-right"></i></a></li>
                                                                        <?php
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    if($sub_products)
                                                                    {
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li><a href="<?php echo base_url('products/details/' . $sub_product['slug']) ?>"><?php echo $sub_product['name'] ?> <i class="w-icon-angle-right pull-right"></i></a></li>
                                                                            <?php
                                                                        }
