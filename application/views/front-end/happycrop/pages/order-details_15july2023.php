<!-- Demo header-->
<style>.orange_msg{background: #FFD580;display: inline-block;padding: 2px 10px;font-weight: 600;color: #555;border-radius: 5px;}.orders-section span{font-size: 13px;}.min-height-175{min-height: 175px;}.shadow{box-shadow: 0 .5rem 1rem rgba(0,0,0,.15) !important;}.btn.btn-sm{text-transform: capitalize;}.h4{font-weight: 600;}</style>
                                            ...
                                            <div class="tmln-outer">
                                                ...
                                                if($order_item_stages)
                                                {
                                                        ...
                                                        <div class="tmln-card">
                                                          <div class="tmln-info">
                                                            ...
                                                            <?php } else if($order_item_stage['status']=='payment_ack') { ?> 
                                                                <h3 class="tmln-title">Transaction details shared with Happycrop. <small class="float-right font-weight-normal"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3>
                                                            ...
                                                            <?php } else if($order_item_stage['status']=='send_payment_confirmation') { ?>
                                                                <h3 class="tmln-title">Payment receipt received from Happycrop. <small class="float-right font-weight-normal"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3> 
                                                                <div class="row">
                                                            ...
                                                            <h3 class="tmln-title">Your concern has been resolved. <small class="float-right font-weight-normal"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3>
                                                            <small>
                                                                <ul>
                                                            ...
                                                            <?php } else if($order_item_stage['status']=='delivered') { ?> 
                                                                ...
                                                                <?php } else { ?>
                                                                <h3 class="tmln-title">Your order delivered successfully. <small class="float-right font-weight-normal"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3>
                                                                <small>
                                                                <ul>
                                                    ...
                                                    if($order_item_stage['active_status'] == 'received' || count($order_item_stages) == 0)
                                                    {
                                                        ...
                                                        <div class="tmln-card in-active">
                                                            <div class="tmln-info">
                                                                <h3 class="tmln-title">Transaction details shared with Happycrop. <small class="float-right font-weight-normal">XXX XX XXX XXXX XX:XX XX</small></h3>
                                                                <p><small>- Waiting for confirmation.</small></p>
                                                            </div>
                                                        </div>
                                                        <div class="tmln-card in-active">
                                                            <div class="tmln-info">
                                                                <h3 class="tmln-title">Payment receipt received from Happycrop. <small class="float-right font-weight-normal">XXX XX XXX XXXX XX:XX XX</small></h3>
                                                        ...
                                                        <div class="tmln-card in-active">
                                                            <div class="tmln-info">
                                                                <h3 class="tmln-title">Your order delivered successfully. <small class="float-right font-weight-normal">XXX XX XXX XXXX XX:XX XX</small></h3>
                                                                <small>
                                                                <ul>
                                                                    <li>- Delivery status shared with Happycrop &amp; manufacturer.</li>
                                                                    <li>- Order closed.</li>
