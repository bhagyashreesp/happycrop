...
.contact-page .content-box{margin:10px 20px;background: #d9d9d9;padding: 20px 40px;border-radius: 12px;}
...
.middle-div, .content-inner {font-size: 2rem;}
.contact-page .content-box h4{color: #456B1C;}
.contact-box label{margin-bottom: 5px;font-size: 1.6rem;}
.contact-box h3.contact-title {font-size: 4rem;color: #75B031;border-color: #336699;}
...
<section id="content" class="pt-5 pb-5 contact-page">
    <div class="main-content">
        <div class="contact-box mb-5">
            <form id="contact-us-form" action="<?=base_url('home/send-contact-us-email')?>" method="POST">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5">
                        <p class="mt-1"><img src="<?php echo base_url('assets/contact_bg.jpg'); ?>" alt="" /></p>
                        <div class="form-group mt-2">
                            <label for="inputAddress">Briefly elaborate on what you to discuss</label>
                            <textarea class="form-control" name="message" rows="4" cols="58" placeholder="Briefly elaborate on what you to discuss"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-5">
                <div class="content-box min-height-220">
