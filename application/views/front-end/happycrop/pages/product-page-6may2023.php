<style>.variation_pro_select {width: 75px;}.num-block {float: left;margin-right: 10px;}.current_active {background: #ECFFA8;}.hc-table td {text-align: center;}.h-title{display: inline-block;border-bottom: 1px solid #000;padding-bottom: 0px;}.product-price2 span{}.product-price2 .h3{font-size:1.5rem !important;font-weight: 600;}.height-26{height: 26px;}</style>
<?php $total_images = 0; ?>
<!-- breadcrumb -->
                            ...
                            <?php } else { ?>
                                <div class="mb-0 mt-2 price">
                                    <div class="bg-grey-efefef border-radius-10 p-3 mb-2">
                                        <h4 class="mb-1 h-title">Price per Product:</h4>
                                        <div class="clearfix height-26">
                                        ...
                                        <div class="clearfix height-26">
                                            <span id="special_price" class="mr-2 mb-0">
                                                Disc. Price: <?php echo $product['product'][0]['variants'][0]['special_price_per_item']; ?>/-
                                            </span>
                                            <span id="you_save" class="mr-2 mb-0">
                                                Saving: <?php echo $product['product'][0]['variants'][0]['price_per_item'] - $product['product'][0]['variants'][0]['special_price_per_item']; ?>/- (<?php echo round((($product['product'][0]['variants'][0]['price_per_item'] - $product['product'][0]['variants'][0]['special_price_per_item'])/$product['product'][0]['variants'][0]['price_per_item'] *100), 2); ?>%)
                                            </span>
                                    ...
                                    <div class="bg-grey-dad9d9 border-radius-10 p-3 mb-2">
                                        <h4 class="mb-1 h-title">Discounted Price for Selected Product:</h4>
                                        <div class="clearfix height-26">
                                            <span id="discounted_price" class="mr-2 h3 mb-0">
                                            Discounted Price: <?php echo $product['product'][0]['variants'][0]['special_price']*1; ?>/-
                                            </span>
                                        </div>
                                        <div class="clearfix height-26">
                                            <span id="you_save_price" class="mr-2 h3 mb-0">
                                            Total Saving: <?php echo $product['product'][0]['variants'][0]['price']-$product['product'][0]['variants'][0]['special_price']; ?>/- (<?php echo round((($product['product'][0]['variants'][0]['price'] - $product['product'][0]['variants'][0]['special_price'])/$product['product'][0]['variants'][0]['price'] *100), 2); ?>%)
                                            </span>
                                        </div>
                                    </div>
                                    <?php /* ?>
