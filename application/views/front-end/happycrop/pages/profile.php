        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 col-12">
                <form class="form-submit-event" method="POST" action="<?= base_url('login/update_user') ?>">
                    ...
                    <button type="submit" class="btn btn-dark btn-rounded btn-md mb-4 "><?=!empty($this->lang->line('save')) ? $this->lang->line('save') : 'Save'?></button><!-- button button-success btn-5 submit_btn -->
