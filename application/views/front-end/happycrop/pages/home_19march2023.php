                    ...
                    <div class="navbar-collapse">
                        <ul class="navbar-nav">
                            ...
                            foreach ($megamenu_blocks as $count_key => $row) 
                            {
                                ?>
                                <li>
                                    <a class="menu-link chemical-fertilizers-icon" href="<?php echo base_url('products/category/' . html_escape($row['slug'])) ?>"><?php echo $row['title'];?></a>
                                    <?php //echo stripallslashes($megamenu['short_description']);?>
                                    <?php
                                                    ...
                                                    <div class="post-details">
                                                        <div class="post-details-visible">
                                                            <div class="text-left">
                                                                ...
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/insect_pests/' . html_escape($row['slug'])) ?>"><?= $row['name'] ?></a></h4>
