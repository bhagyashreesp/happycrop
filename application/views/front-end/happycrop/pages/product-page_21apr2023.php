<style>.variation_pro_select {width: 75px;}.num-block {float: left;margin-right: 10px;}.current_active {background: #ECFFA8;}.hc-table td {text-align: center;}</style>
<?php $total_images = 0; ?>
<!-- breadcrumb -->
                            ...
                            <?php } else { ?>
                                <div class="mb-0 mt-2 price">
                                    <div class="bg-grey-efefef border-radius-10 p-3 mb-2">
                                        <h4 class="mb-1">Price per Product:</h4>
                                        ...
                                        <span id="you_save" class="mr-2 mb-1">
                                         ...
                                         <span id="discount" class="mr-2 mb-1"></span>
                                        <div class="clearfix"></div>
                                        
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="bg-grey-dad9d9 border-radius-10 p-3 mb-2">
                                        <h4 class="mb-1">Discounted Price for Selected Product:</h4>
                                        ...
                                        Total Saving: <?php echo $product['product'][0]['variants'][0]['price']-$product['product'][0]['variants'][0]['special_price']; ?>/-
                                        </span>
                                    </div>
                                    <?php /* ?>
                                    <sup>
