            ...
            <div class="col-md-10 col-12">
                ...
                <div class="card content-area border-none p-4">
                    <div class="card-innr">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select id="order_status" name="order_status" placeholder="Select Status" required="" class="form-control">
                                                ...
                                                <option value="delivered">Order Closed</option>
                        ...
                        <?php } else { ?>
                            <?php
                            $condition_arr = array('1'=>'In Process Orders','2'=>'Shipped Orders','3'=>'Issue Raised','4'=>'Cancelled Orders','5'=>'Delivered Orders');
                            ?>
