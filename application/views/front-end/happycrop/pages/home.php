<main class="main">
                    ...
                    <div class="navbar-collapse">
                        <ul class="navbar-nav">
                            ...
                            foreach($megamenus as $megamenu)
                            {
                                ?>
                                <li>
                                    <a class="menu-link chemical-fertilizers-icon" href="#"><?php echo $megamenu['title'];?></a>
                                    <?php echo stripallslashes($megamenu['short_description']);?>
                                </li>
                                <?php
                            }
                            ?>
            ...
            <div class="container">
                <nav class="navbar">
                    <div class="navbar-collapse justify-content-center">
                        <ul class="navbar-nav">
                            <?php
                            foreach ($megamenu_blocks as $count_key => $row) 
                            {
                                ?>
                                <li>
                                    <?php 
                                    ...
                                    {
                                        ?>
                                        <a class="menu-link chemical-fertilizers-icon--" href="<?php echo base_url('products/categories/' . html_escape($row['slug'])) ?>">
                                            <figure>
                                                <img class="small_thumb" src="<?php echo base_url().$row['image']; ?>" alt="<?php echo $row['title'];?>" />
                                            </figure>
                                            <?php echo $row['title'];?>
                                        </a>
                                        <?php
                                    }
                                    else if($row['show_type'] == 2)
                                    {
                                        ?>
                                        <a class="menu-link chemical-fertilizers-icon--" href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>">
                                            <figure>
                                                <img class="small_thumb" src="<?php echo base_url().$row['image']; ?>" alt="<?php echo $row['title'];?>" />
                                            </figure>
                                            <?php echo $row['title'];?>
                                    ...
                                    else if($row['show_type'] == 3)
                                    {
                                        ?>
                                        <a class="menu-link chemical-fertilizers-icon--" href="<?php echo base_url('products/services/' . html_escape($row['slug'])) ?>">
                                            <figure>
                                                <img class="small_thumb" src="<?php echo base_url().$row['image']; ?>" alt="<?php echo $row['title'];?>" />
                                            </figure>
                                            <?php echo $row['title'];?>
                                    ...
                                    <?php //echo stripallslashes($megamenu['short_description']);?>
                                    <?php
                                    $subcategories = $row['sub_cat_info'];
                                    if($subcategories)
                                    {
                                        ?>
                                        <div class="sub-menu">
                                        ...
                                        foreach($subcategories as $subcategory)
                                        {
                                            ...
                                            <div class="sub-menu-item">
                                                ...
                                                {
                                                    ?>
                                                    <h4 class="menu-title"><a href="<?php echo base_url('products/categories/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h4>
                                                    <?php
                                                }
                                                else if($row['show_type'] == 2)
                                                {
                                                    ?>
                                                    <h4 class="menu-title"><a href="<?php echo base_url('products/insects/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h4>
                                                    <?php
                                                }
                                                else if($row['show_type'] == 3)
                                                {
                                                    ?>
                                                    <h4 class="menu-title"><a href="<?php echo base_url('products/services/' . html_escape($subcategory['slug'])) ?>"><?php echo $subcategory['name'];?></a></h4>
                                                    <?php
                                                }
                                                ?>
                                                <ul>
                                                    <?php
                                                    if(!empty($subcategory['sub_categories']))
                                                    {
                                                        $sub_cats = $subcategory['sub_categories'];
                                                        if($row['show_type'] == 1)
                                                        {
                                                            foreach($sub_cats as $sub_cat)
                                                            {
                                                                ?>
                                                                <li><a href="<?php echo base_url('products/category/' . html_escape($sub_cat['slug'])) ?>"><?php echo $sub_cat['name'] ?></a></li>
                                                                <?php
                                                            }
                                                            ?>
                                                            <li><a href="<?php echo base_url('products/categories/' . html_escape($subcategory['slug'])) ?>">View More</a></li>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <li><a href="<?php echo base_url('products/insect_pests/' . html_escape($sub_cat['slug'])) ?>"><?php echo $sub_cat['name'] ?></a></li>
                                                                <?php
                                                            }
                                                            ?>
                                                            <li><a href="<?php echo base_url('products/insects/' . html_escape($subcategory['slug'])) ?>">View More</a></li>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 3)
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <li><a href="<?php echo base_url('products/service/' . html_escape($sub_cat['slug'])) ?>"><?php echo $sub_cat['name'] ?></a></li>
                                                                <?php
                                                            }
                                                            ?>
                                                            <li><a href="<?php echo base_url('products/services/' . html_escape($subcategory['slug'])) ?>">View More</a></li>
                                                            <?php
                                                        }
                                                    }
                                                    else
                                                    {
                                                        $sub_products = $subcategory['product_details'];
                                                        if($sub_products)
                                                        {
                                                            foreach($sub_products as $sub_product)
                                                            {
                                                                ?>
                                                                <li><a href="<?php echo base_url('products/details/' . $sub_product['slug']) ?>"><?php echo $sub_product['name'] ?></a></li>
                                                                <?php
                                                            }
    ...
    if($category_blocks)
    {
        ...
        $offers =  get_offers();
        $kk = 0;
        foreach ($category_blocks as $count_key => $row) {
            
            ?>
            <div class="bg-light custom-product-div-1">
                <div class="container d-xs-show  d-lg-show">
                    <div class="product-wrapper-1 custom-product-wrapper-1 appear-animate mb-5">
                        <div class="title-link-wrapper pb-1 mt-2 mb-2">
                            <?php 
                            if($row['show_type'] == 1)
                            {
                                ?>
                                <h2 class="title ls-normal mb-0"><a href="<?php echo base_url('products/categories/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?></a></h2>
                                <?php
                            }
                            else if($row['show_type'] == 2)
                            {
                                ?>
                                <h2 class="title ls-normal mb-0"><a href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?></a></h2>
                                <?php  
                            }
                            else if($row['show_type'] == 3)
                            {
                                ?>
                                <h2 class="title ls-normal mb-0"><a href="<?php echo base_url('products/services/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?></a></h2>
                                <?php
                            }
                            ?>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="grid-item fashion" >
                                            <article class="post post-mask overlay-zoom br-sm">
                                                <?php
                                                if (!empty($offers) && !empty($offers[$offer_counter])) { ?>
                                                    <div class="swiper-container swiper-theme banner-swiper swiper-theme nav-inner pg-inner swiper-nav-lg animation-slider" data-swiper-options="{autoplay: {delay: 2000,}}">
                                                    <div class="swiper-wrapper">
                                                   
                                                    <?php for($k=0;$k<3;$k++) { ?> 
                                                    <div class="swiper-slide" data-swiper-autoplay="2000">
                                                    <!--<figure class="post-media">-->
                                                    <a href="<?= $offers[$offer_counter]['link'] ?>">
                                                        <img class="img-fluid lazy" data-src="<?= base_url($offers[$offer_counter]['image']) ?>">
                                                    </a>
                                                    <!--</figure>-->
                                                    </div>
                                                    <?php
                                                ...
                                                else 
                                                {
                                                    ...
                                                    <figure class="post-media">
                                                        ...
                                                        {
                                                            ?>
                                                            <a href="<?php echo base_url('products/categories/' . html_escape($row['slug'])) ?>">
                                                                <img src="<?php echo $row['banner'] ?>" alt="<?= $row['name'] ?>" />
                                                            </a>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ?>
                                                            <a href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>">
                                                                <img src="<?php echo $row['banner'] ?>" alt="<?= $row['name'] ?>" />
                                                            </a>
                                                            <?php  
                                                        }
                                                        ...
                                                        {
                                                            ?>
                                                            <a href="<?php echo base_url('products/services/' . html_escape($row['slug'])) ?>">
                                                                <img src="<?php echo $row['banner'] ?>" alt="<?= $row['name'] ?>" />
                                                            </a>
                                                            <?php
                                                        }
                                                    ...
                                                    <div class="post-details">
                                                        <div class="post-details-visible">
                                                            <div class="text-left">
                                                                ...
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/categories/' . html_escape($row['slug'])) ?>"><?= $row['name'] ?></a></h4>
                                                                    <a href="<?php echo base_url('products/categories/' . html_escape($row['slug'])) ?>" class="btn btn-white btn-rounded btn-sm">View All</a>
                                                                    <?php
                                                                }
                                                                else if($row['show_type'] == 2)
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>"><?= ucfirst($row['title']) ?><?php //echo $row['name'] ?></a></h4>
                                                                    <a href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>" class="btn btn-white btn-rounded btn-sm">View All</a>
                                                                    <?php  
                                                                }
                                                                else if($row['show_type'] == 3)
                                                                {
                                                                    ?>
                                                                    <h4 class="post-title text-white"><a href="<?php echo base_url('products/services/' . html_escape($row['slug'])) ?>"><?= $row['title'] ?></a></h4>
                                                                    <a href="<?php echo base_url('products/services/' . html_escape($row['slug'])) ?>" class="btn btn-white btn-rounded btn-sm">View All</a>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
                                ...
                                if($subcategories)
                                {
                                    foreach($subcategories as $subcategory)
                                    {
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="box height_210">
                                                <div class="row">
                                                    <?php /* ?>
                                                    <div class="col-lg-4">
                                                        <a href="<?php echo base_url('products/category/' . html_escape($subcategory['slug'])) ?>">
                                                            <img src="<?php echo $subcategory['image'] ?>" alt="<?php echo $subcategory['name'];?>" />
                                                        </a>
                                                    </div>
                                                    <?php */ ?>
                                                    <div class="col-lg-12">
                                                        ...
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/categories/' . html_escape($subcategory['slug'])) ?>"><?php echo ucwords(strtolower($subcategory['name']));?></a></h6>
                                                            <?php
                                                        }
                                                        else if($row['show_type'] == 2)
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/insects/' . html_escape($subcategory['slug'])) ?>"><?php echo ucwords(strtolower($subcategory['name']));?></a></h6>
                                                            <?php
                                                        }  
                                                        else if($row['show_type'] == 3)
                                                        {
                                                            ?>
                                                            <h6 class="mb-0"><a href="<?php echo base_url('products/services/' . html_escape($subcategory['slug'])) ?>"><?php echo ucwords(strtolower($subcategory['name']));?></a></h6>
                                                            <?php
                                                        }
                                                        ?>
            ...
            <!-- accordion -->
            <section class="color-accordion-section bg-light-green--">
                <div class="container d-lg-none pt-3 <?php echo (count($category_blocks) == $count_key+1) ? 'pb-3' : 'pb-1';?>  "> 
                    <div class="row">
                        <div class="col-9">
                            <h2 class="title mb-2"><?= ucfirst($row['title']) ?></h2>
                        </div>
                        <div class="col-3 text-center">
                            ...
                            {
                                ?>
                                <a href="<?= base_url('products/categories/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm btn-sm-view-more">View All</a>
                                <?php
                            }
                            else if($row['show_type'] == 2)
                            {
                                ?>
                                <a href="<?php echo base_url('products/insects/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm btn-sm-view-more">View All</a>
                                <?php
                            }  
                            else if($row['show_type'] == 3)
                            {
                                ?>
                                <a href="<?= base_url('products/services/' . html_escape($row['slug'])) ?>" class="btn btn-rounded btn-sm btn-sm-view-more">View All</a>
                                <?php
                            }
                            ?>
                        </div>
                                ...
                                <div class="row--">
                                    ...
                                    if($subcategories)
                                    {
                                        ...
                                        foreach($subcategories as $subcategory)
                                        {
                                            ...
                                            ?>
                                            <div class="card bg-white-- new-hp-acc">
                                                <div class="card-header">
                                                    <a href="#collapse<?php echo $subcategory['id'];?>" class="<?php echo $expand;?> bg-white--"><?php echo ucwords(strtolower($subcategory['name']));?></a>
                                                </div>
                                                <div class="card-body <?php echo $collapse;?>" id="collapse<?php echo $subcategory['id'];?>">
                                                    <div class="row">
                                                        <?php /* ?>
                                                        ...
                                                        <?php */ ?>
                                                        <div class="col-12 ">
                                                            <ul class="widget-body row card-menu">
                                                                <?php
                                                                if(!empty($subcategory['sub_categories']))
                                                                {
                                                                    $sub_cats = $subcategory['sub_categories'];
                                                                    foreach($sub_cats as $sub_cat)
                                                                    {
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/category/' . html_escape($sub_cat['slug'])) ?>" title="<?php echo $sub_cat['name'] ?>"><span><?php echo $sub_cat['name'] ?></span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 2)
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/insect_pests/' . html_escape($sub_cat['slug'])) ?>" title="<?php echo $sub_cat['name'] ?>"><span><?php echo $sub_cat['name'] ?></span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 3)
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/service/' . html_escape($sub_cat['slug'])) ?>" title="<?php echo $sub_cat['name'] ?>"><span><?php echo $sub_cat['name'] ?></span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <li class="col-4- col-12"><a href="<?php echo base_url('products/categories/' . html_escape($subcategory['slug'])) ?>" title="View More"><span class="text-primary">View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                        <?php
                                                                    }
                                                                    else if($row['show_type'] == 2)
                                                                    {
                                                                        ?>
                                                                        <li class="col-4- col-12"><a href="<?php echo base_url('products/insects/' . html_escape($subcategory['slug'])) ?>" title="View More"><span class="text-primary">View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                        <?php
                                                                    }
                                                                    else if($row['show_type'] == 3)
                                                                    {
                                                                        ?>
                                                                        <li class="col-4- col-12"><a href="<?php echo base_url('products/services/' . html_escape($subcategory['slug'])) ?>" title="View More"><span class="text-primary">View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                        <?php
                                                                    }
                                                                }
                                                                else
                                                                {
                                                                    ...
                                                                    if($sub_products)
                                                                    {
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/details/' . $sub_product['slug']) ?>" title="<?php echo $sub_product['name'] ?>"><span><?php echo $sub_product['name'] ?> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/categories/' . html_escape($subcategory['slug'])) ?>" title="View More" class="text-primary"><span>View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 2)
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/insects/' . html_escape($subcategory['slug'])) ?>" title="View More" class="text-primary"><span>View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                        else if($row['show_type'] == 3)
                                                                        {
                                                                            ?>
                                                                            <li class="col-4- col-12"><a href="<?php echo base_url('products/services/' . html_escape($subcategory['slug'])) ?>" title="View More" class="text-primary"><span>View More...</span> <!--<i class="w-icon-angle-right pull-right"></i>--></a></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                                }
    ...
    foreach ($sections as $count_key => $row) {
        if (!empty($row['product_details'])) {
            ...
            <?php } else if ($row['style'] == 'style_5') { 
                ...
                <!-- Style 5 Design -->
                <div class="bg-light custom-product-div-1">
                    <div class="container d-xs-show ">  
                        <div class="product-wrapper-1 custom-product-wrapper-1 appear-animate mb-5">
                            <div class="title-link-wrapper pb-1 mt-2 mb-2">
                                <h2 class="title ls-normal mb-0"><?= ucfirst($row['title']) ?></h2>
                            </div>
                        ...
                        <div class="info-box-wrapper inline-element">
                            <div class="box-icon info-box custom light-color">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <div class="info-box-inner">
                                        <p><?= $web_settings['support_description'] ?></p>
                                    </div>
                                    </h4>
                                </div>
                            </div>
