               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/orders/') ?>" class="nav-link">
                        <i class="nav-icon fas fa-shopping-cart text-black"></i><br />
                        <p>
                            Orders
                        </p>
                    </a>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/orders/accounts/') ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/product/') ?>" class="nav-link">
                        <i class="fas fa-cubes nav-icon"></i><br />
                        <p>Products</p>
                    </a>
                </li>
                
                <li class="nav-item">
                    <a href="<?= base_url('seller/webinars/') ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/promotion/') ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('seller/subscriptions/') ?>" class="nav-link">
                        <i class="fas fa-briefcase nav-icon"></i><br />
                        <p>Subscriptions</p>
                    </a>
                </li>
                
                <li class="nav-item">
                    <a href="<?= base_url('seller/profile/settings/') ?>" class="nav-link">
