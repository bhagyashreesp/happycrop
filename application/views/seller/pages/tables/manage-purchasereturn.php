                    ...
                    <div class="card content-area pt-4">
                        <div class="col-md-12 pt-2">
                            <div class="row col-md-12">
                                <div class="col-md-2">
                                    <a href="<?php echo base_url() . 'seller/orders/external-purchase-return'; ?>" class='button-- button-danger-outline-- btn btn-primary btn-sm d-inline-block '>Add New Record</a>
