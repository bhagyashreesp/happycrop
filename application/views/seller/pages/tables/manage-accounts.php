                    ...
                    <div class="card- card-info mb-0">
                        <ul class="nav nav-tabs pb-0" id="myTab" >
                            <li class="nav-item active">
                                <a class="nav-link btn btn-primary" href="<?php echo base_url('seller/orders/accounts/') ?>">Accounts</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo base_url('seller/orders/statements/') ?>">Statements</a>
                            </li>
                        </ul>
                    </div>
