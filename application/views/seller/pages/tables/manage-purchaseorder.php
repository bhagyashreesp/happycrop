                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content mt-2">
                                <div id="system" class="tab-pane fade show in active">
                                    ...
                                    <table class='table-striped' data-toggle="table" data-url="<?= base_url('seller/orders/view_seller_account_orders_filter?order_status=received') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="o.last_updated" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["pdf","excel","csv"]' data-export-options='{"fileName": "report","ignoreColumn": ["purchase_order"] }' data-query-params="orders_query_params">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="purchase_order" data-sortable='false' data-visible='true'>Sale Order</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                                <div id="external" class="tab-pane fade">
                                    <div class="row col-md-12">
                                        <div class="col-md-2">
                                            <a href="<?php echo base_url() . 'seller/orders/external-sale-order'; ?>" class='button-- button-danger-outline-- btn btn-primary btn-sm d-inline-block '>Add Sale Order</a>
                                        </div>
                                        <div class="col-md-2">
                                            <label>From Date</label>
                                    ...
                                    <table class='table-striped table-resp' data-toggle="table" data-url="<?= base_url('my-account/get_external_purchasebill_ist/?order_status=2') ?>" data-order_status="send_invoice" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="o.last_updated" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["pdf","excel","csv"]' data-export-options='{"fileName": "report","ignoreColumn": ["sale_order"] }' data-query-params="external_orders_query_params">
                                        <thead>
                                            <tr class="dark-blue-bg">
                                                ...
                                                <th data-field="sale_order" data-sortable='false' data-visible='true'>Sale Order</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
