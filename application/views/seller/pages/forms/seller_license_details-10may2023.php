                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <div class="col-md-6">
                                    <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('seller/profile/save_license_details/') ?>' method="post" enctype="multipart/form-data">
