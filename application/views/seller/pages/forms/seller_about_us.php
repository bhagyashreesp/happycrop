                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <ul class="nav nav-tabs" id="myTab" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url('seller/profile/about_us/') ?>">About Us</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <div class="col-md-12">
                                    <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('seller/profile/save_about_us/') ?>' method="post" enctype="multipart/form-data">
