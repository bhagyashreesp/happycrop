                    ...
                    <div class="shadow p-3 mb-3 bg-white rounded">
                        ...
                        <table class="table table-bordered">
                            <tr class="bg-primary text-white">
                                ...
                                <th style="width: 13%;">Order Volume</th>
                            ...
                            foreach ($items as $item) {
                                ...
                                <tr id="row_<?php echo $item['id'];?>">
                                    ...
                                    <?php */ ?>
                                    <td><?= $item['pname'] ?></td>
                                    <td><?php echo $item['packing_size'].' '.$item['unit']; echo ($item['carton_qty'] > 1) ? ' &#x2715; '.$item['carton_qty'] : '&#x2715; 1'; ?></td>
                                    <td>
                                            ...
                                            <div class="tmln-card">
                                                <div class="tmln-info">
                                                    ...
                                                    {*/
                                                        ...
                                                        <div><small class="text-danger p-1 bg-red font-weight-bold" style="color: #fff !important;">Note - Action needs to be taken within 5 days from date of order or else order will be auto canceled.</small></div>
                                                        <?php
                                                    //}
                                                    ?>
                                                </div>
                                                    ...
                                                    <div class="tmln-info">
                                                        ...
                                                        */
                                                        ...
                                                        <?php } else if($order_item_stage['status']=='send_invoice') { ?> 
                                                                ...
                                                                <p><small class="text-danger p-1 bg-red font-weight-bold" style="color: #fff !important;">Note – In case of incomplete order, damaged products or incorrect order, manufacturer bound to refund the amount against particular concern.</small></p>
                                                                <?php /* ?>
                                                                <table class="table table-bordered">
                                                                    <tr class="bg-primary text-white">
                                                                        <th style="width: 8%;">Sr. No.</th>
                                                                ...
                                                                if($ids)
                                                                {
                                                                    ...
                                                                    if($order_item_mfg_payment_acks)
                                                                    {
                                                                        ...
                                                                        foreach($order_item_mfg_payment_acks as $order_item_mfg_payment_ack)
                                                                        {
                                                                            ...
                                                                            {
                                                                                ?><a class="btn btn-sm col-md-3 btn-primary mb-1" href="<?php echo base_url().$order_item_mfg_payment_ack['attachments'];?>" target="_blank">Download Confirmation</a><?php
                                                                                $i_count++;
                                                                            }
                                                                        }
                                                                    }
