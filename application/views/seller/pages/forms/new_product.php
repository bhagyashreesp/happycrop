            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="<?= base_url('seller/product/products/'.$super_category_id) ?>"><?php echo $super_category_name; ?> Products</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="licence_no" name="licence_no" value="<?= (isset($product_details[0]['licence_no'])) ? $product_details[0]['licence_no'] : $licence_no; ?>" placeholder='Licence Number' readonly=""/>
                                    </div>
                                    <?php 
                                    if($super_category_id == 1 || $super_category_id == 2 || $super_category_id == 5)
                                    {
                                        ?>
                                        <div class="col-md-4">
                                            <label for="toxicity_id" class="col-form-label">Toxicity <span class='text-danger text-sm'>*</span></label>
                                    ...
                                    if($super_category_id == 3)
                                    {
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-3" id="pro_specifications">
                                                ...
                                                ?>
                                                <?php /* ?>
                                                <textarea id="pro_input_specifications" name="pro_input_specifications" class="textarea" placeholder="Place some text here"><?= (isset($product_details[0]['specifications'])) ? stripslashes($product_details[0]['specifications']) : ''; ?></textarea>
                                                <?php */ ?>
