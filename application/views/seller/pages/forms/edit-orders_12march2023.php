                    ...
                    <div class="shadow p-3 mb-3 bg-white rounded">
                        ...
                        <table class="table table-bordered">
                            <tr class="bg-primary text-white">
                                ...
                                <th style="width: 12%;">Order Volume</th>
                                                ...
                                                <div class="tmln-card">
                                                    <div class="tmln-info">
                                                        ...
                                                        <?php } else if($order_item_stage['status']=='delivered') { ?> 
                                                                <h3 class="tmln-title">Order has been closed.  <small class="float-right"><?php echo date('l d M Y h:i A',strtotime($order_item_stage['created_date'])); ?></small></h3>
