                            ...
                            <div class="card-body">
                                <div class="form-group row mt-3">
                                    <div class="col-md-4">
                                        ...
                                        <select class='form-control select_search' name='parent_id' id="parent_id" onchange="getSubcategories(this.value,'category_id');">
                                ...
                                <div class="col-12 mb-3">
                                    <table class="table table-bordered price-table">
                                        ...
                                        if($product_variants)
                                        {
                                            ...
                                            foreach($product_variants as $product_variant)
                                            {
                                                ...
                                                <tr id="row_<?php echo $p;?>">
                                                    <td>
                                                        <input type="text" id="packing_size_<?php echo $p;?>" name="packing_size[]" class="form-control width-120" value="<?php echo $product_variant['packing_size']; ?>" onkeyup="calculateWeightRow(<?php echo $p;?>);"/>
                                                    </td>
                                                    <td>
                                                        <select id="unit_id_<?php echo $p;?>" name="unit_id[]" class="form-control">
                                                            <option value="">Select</option>
                                                            <?php 
                                                    ...
                                                    <td>
                                                        <input type="text" id="carton_qty_<?php echo $p;?>" name="carton_qty[]" class="form-control width-120" value="<?php echo $product_variant['carton_qty']; ?>" onkeyup="calculateMRPRow(<?php echo $p;?>);calculatePriceRow(<?php echo $p;?>);calculateSplPriceRow(<?php echo $p;?>);calculateWeightRow(<?php echo $p;?>);" />
                                                    </td>
                                                    <td>
                                        ...
                                        else
                                        {
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" id="packing_size_<?php echo $p;?>" name="packing_size[]" class="form-control width-120" onkeyup="calculateWeightRow(<?php echo $p;?>);"/>
                                                </td>
                                                <td>
                                                    <select id="unit_id_<?php echo $p;?>" name="unit_id[]" class="form-control">
                                                        <option value="">Select</option>
                                                ...
                                                <td>
                                                    <input type="text" id="carton_qty_<?php echo $p;?>" name="carton_qty[]" class="form-control width-120" value="1" onkeyup="calculateMRPRow(<?php echo $p;?>);calculatePriceRow(<?php echo $p;?>);calculateSplPriceRow(<?php echo $p;?>);calculateWeightRow(<?php echo $p;?>);"  />
                                                </td>
                                                <td>
