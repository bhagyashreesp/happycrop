            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <form id='basic-details-form' class='basic-details-form not-editable' action='<?php echo base_url('seller/profile/save_bussiness_details/') ?>' method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class='form-control editable' placeholder="Brand Name" id="brand_name" name="brand_name" value=""/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                            ...
                                                            foreach($seller_brands as $seller_brand)
                                                            {
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Brand Name</label>
                                                                            <input type="text" class='form-control editable' placeholder="Brand Name" id="brand_name_<?php echo $seller_brand['id']; ?>" name="brand_name_<?php echo $seller_brand['id']; ?>" value="<?php echo $seller_brand['brand_name']; ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group pt-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <div id="img_div">
                                                    ...
                                                    <a class="btn btn-primary btn-browse  btn-rounded btn-sm mb-3" href="javascript:void(0);" onclick="$('#logo').click();">Select File</a>
