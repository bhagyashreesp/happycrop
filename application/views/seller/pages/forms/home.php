...
@media screen and (min-width: 992px){
    .chart-height, .carousel-item img{height: 380px;}
}
</style>
            ...
            <div class="card  content-area p-2">    
                <div class="row">
                    <div class="col-md-10 bg-white">
                        <h4 class="h6 mt-3 mb-1">Hello <?php echo $seller_data['company_name'];?></h4>
                        <h4 class="h6 mt-0 mb-1">ID - <?php echo $mfg_no;?></h4>
                        <p class="mt-0">Joined Date - <?php echo $join_date;?></p>
                    </div>
                    <div class="col-md-2 text-center">
                        <?php if(file_exists($seller_data['logo']) && $seller_data['logo']!='') { ?> 
                        <div class="logo brand-link-- p-2--">
                            <img class="brand-image-- avt_img mb-3--" src="<?php echo base_url().$seller_data['logo'];?>" alt="<?php echo $seller_data['company_name'];?>"/>
                        </div>
                        <?php } else { ?>
                ...
                <div class="card-innr">
                    ...
                    <div class="row dash-bg-gray">
                        <div class="col-md-5">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="dash-widget-1 small-box bg-white min-height-162 mt-2 mb-2">
                                ...
                                <div class="col-md-6">
                                    <div class="dash-widget-1 small-box bg-white min-height-162 mt-2 mb-2">
                                        <a href="<?php echo base_url('seller/orders');?>" target="_self">
                                            <i class="fa fa-shopping-bag"></i>
                                            <h3><?= number_format($status_counts['total_orders']) ?></h3>
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mt-2 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/6');?>" target="_self">
                                            <h5 class=""><i class="fa fa-check-square"></i> <?= number_format($status_counts['new_orders']) ?></h5>
                                            <h5 class="">New Orders</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mt-2 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/1');?>" target="_self">
                                ...
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mt-2 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/2');?>" target="_self">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/3');?>" target="_self">
                                ...
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/4');?>" target="_self">
                                ...
                                <div class="col-md-4">
                                    <div class="dash-widget-1 mb-2">
                                        <a href="<?php echo base_url('seller/orders/show_orders/5');?>" target="_self">
                                ...
                                { 
                                    ...
                                    { 
                                        ...
                                        <div class="carousel-item <?php echo ($si == 0) ? 'active' : ''; ?>">
                                            <img class="d-block w-100" src="<?= base_url($row['image']) ?>" alt="" />
                                        </div>
                                        <?php 
                                        $si++;
                                    }  
