                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <div class="col-md-4">
                                    <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('seller/profile/save_bank_details/') ?>' method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Account Holder Name *</label>
                                            <input type="text" class='form-control' placeholder="Account Holder Name" id="account_name" name="account_name" value="<?php echo $seller_data->account_name;?>"/>
                                        </div>
                                        <div class="form-group">
