...
<!-- Highchart -->
<script src="<?= base_url('assets/admin/highchart/highcharts.js') ?>"></script>
<script src="<?= base_url('assets/admin/highchart/modules/exporting.js') ?>"></script>
<script src="<?= base_url('assets/admin/highchart/modules/export-data.js') ?>"></script>
<script src="<?= base_url('assets/admin/highchart/modules/accessibility.js') ?>"></script>
<!-- Tool Tip -->
...
<!-- Custom -->
<script src="<?= base_url('assets/admin/custom/custom.js?v=12.2') ?>"></script>
<!-- Demo -->
