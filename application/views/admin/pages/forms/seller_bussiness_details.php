                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <ul class="nav nav-tabs" id="myTab" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url('admin/sellers/bussiness_details?edit_id='.$user_id) ?>">Business Details</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('admin/sellers/save_bussiness_details/') ?>' method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-group pt-2">
                                                        ...
                                                        function addBrandName()
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                $.ajax({
                                                                    type: 'POST',
                                                                    url: '<?php echo base_url();?>admin/sellers/addBrandName',
                                                                    data: {brand_name:brand_name, seller_id: <?php echo $user_id; ?>},
                                                                    beforeSend: function () {
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    function updateBrandName(id)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            $.ajax({
                                                                type: 'POST',
                                                                url: '<?php echo base_url();?>admin/sellers/updateBrandName',
                                                                data: {id:id,brand_name:brand_name, seller_id: <?php echo $user_id; ?>},
                                                                beforeSend: function () {
