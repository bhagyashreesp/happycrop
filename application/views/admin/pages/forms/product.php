                                                            ...
                                                            ?>
                                                                <div id="general_price_section">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <input type="number" name="simple_mrp" class="form-control " value="<?= $product_variants[0]['mrp'] ?>" min='0' step="0.01">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="type" class="col-md-2">Wholesale Price:</label>
                                                                        <div class="col-md-12">
                                                                    ...
                                                                    <div id="product-general-settings">
                                                                        <div id="general_price_section" class="collapse">
                                                                            <div class="form-group">
                                                                                <label for="type" class="col-md-2">MRP:</label>
                                                                                <div class="col-md-12">
                                                                                    <input type="number" name="simple_mrp" class="form-control" min='0' step="0.01">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="type" class="col-md-2">Wholesale Price:</label>
