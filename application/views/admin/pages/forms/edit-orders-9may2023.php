                ...
                <div class="col-md-12">
                    <div class="shadow p-3 mb-3 bg-white rounded">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <h6 class="mb-1 h6">License Details</h6>
                            ...
                            <div class="col-md-4">
                                <h6 class="mb-1 h6">Bank Details</h6>
                                                ...
                                                <div class="tmln-card">
                                                    <div class="tmln-info">
                                                        ...
                                                        <?php } else if($order_item_stage['status']=='delivered') { ?> 
                                                                ...
                                                                <small>- Please release payment (<?php echo $settings['currency'] . ' ' . number_format($order_detls[0]['final_total'], 2); ?>/-) to <?php echo $order_detls[0]['seller_name']; ?> and upload transaction details.</small>
                                                                <?php
                                                                if(count($order_item_stages) == $_count)
                                                                {
                                                                    ?>
