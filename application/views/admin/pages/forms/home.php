...
.text-danger span.bg-danger {min-width: 24px;display: inline-block;text-align: center;}
</style>
        ...
        <div class="container-fluid p-3">
                            ...
                            <div class="col-md-5 col-lg-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="small-box bg-white">
                                            <div class="inner text-center pt-5 pb-5">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders');?>" target="_self">
                            ...
                            <div class="col-md-7 col-lg-7">
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/6');?>" target="_self">
                                    ...
                                    <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/1');?>" target="_self">
                                    ...
                                    <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/2');?>" target="_self">
                                ...
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/3');?>" target="_self">
                                     ...
                                     <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/4');?>" target="_self">
                                     ...
                                     <div class="col-md-4">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/5');?>" target="_self">
            ...
            <div class="card  content-area pl-3 pr-3 pt-4 pb-1 bg-secondary">
                <div class="card-innr">
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Manufactures Overview</h6>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="text-dark" href="<?php echo base_url('admin/sellers');?>" target="_blank">
                                                <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo $mfg_total; ?></h5>
                                                <p class="mb-1">Total Manufacturers</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="text-dark" href="<?php echo base_url('admin/sellers/approved');?>" target="_blank">
                                                <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo $approved_mfg; ?></h5>
                                ...
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="<?php echo ($unapproved_mfg) ? 'text-danger' : 'text-dark';?>" href="<?php echo base_url('admin/sellers/unapproved');?>" target="_blank">
                                                <h5 class="<?php echo ($unapproved_mfg) ? 'font-16' : '';?>"><span class="<?php echo ($unapproved_mfg) ? 'bg-danger p-1' : '';?>"><?php echo $unapproved_mfg; ?></span></h5>
                                                <p class="mb-1">Unapproved</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <h6>Retailers Overview</h6>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="text-dark" href="<?php echo base_url('admin/retailers');?>" target="_blank">
                                                <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo $retailer_total; ?></h5>
                                                <p class="mb-1">Total Retailers</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="text-dark" href="<?php echo base_url('admin/retailers/approved');?>" target="_blank">
                                                <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo $approved_retailer; ?></h5>
                                                <p class="mb-1">Approved</p>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="small-box  bg-white">
                                        <div class="inner text-left">
                                            <a class="<?php echo ($unapproved_retailer) ? 'text-danger' : 'text-dark';?>" href="<?php echo base_url('admin/retailers/unapproved');?>" target="_blank">
                                                <h5 class="<?php echo ($unapproved_retailer) ? 'font-16' : '';?>"><span class="<?php echo ($unapproved_retailer) ? 'bg-danger p-1' : '';?>"><?php echo $unapproved_retailer; ?></span></h5>
                                                <p class="mb-1">Unapproved</p>
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="card  content-area pl-3 pr-3 pt-4 pb-1 bg-secondary">
                <div class="card-innr">
                    ...
                    if($super_categories)
                    {
                        ...
                        {
                            $unapproved_products = total_products_by_super_category($super_cat['id'], 2);
                            ?>
                            <div class="col-md-6">
                                <h6><?php echo $super_cat['name']; ?></h6>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/product/products/'.$super_cat['id']);?>" target="_blank">
                                                    <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo total_products_by_super_category($super_cat['id'], array(0,1,2)); ?></h5>
                                                    <p class="mb-0"><small class="text-dark mt-0">Total</small></p>
                                                    <p class="mb-1 mt-0"><small class="text-dark mt-0">Products</small></p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/product/products/'.$super_cat['id'].'/1');?>" target="_blank">
                                                    <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo total_products_by_super_category($super_cat['id'], 1); ?></h5>
                                                    <p class="mb-0"><small class="text-dark mt-0">Approved</small></p>
                                                    <p class="mb-1 mt-0"><small class="text-dark mt-0">Products</small></p>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="<?php echo ($unapproved_products) ? 'text-danger' : 'text-dark';?>" href="<?php echo base_url('admin/product/products/'.$super_cat['id'].'/2');?>" target="_blank">
                                                    <h5 class="<?php echo ($unapproved_products) ? 'font-16' : '';?>"><span class="<?php echo ($unapproved_products) ? 'bg-danger p-1' : '';?>"><?php echo $unapproved_products; ?></span></h5>
                                                    <p class="mb-0"><small class="<?php echo ($unapproved_products) ? 'text-danger' : 'text-dark';?> mt-0">Unapproved</small></p>
                                                    <p class="mb-1 mt-0"><small class="<?php echo ($unapproved_products) ? 'text-danger' : 'text-dark';?> mt-0">Products</small></p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/product/products/'.$super_cat['id'].'/0');?>" target="_blank">
                                                    <h5 class=""><!--<i class="fa fa-check-square"></i>--> <?php echo total_products_by_super_category($super_cat['id'], array(0)); ?></h5>
                                                    <p class="mb-0"><small class="text-dark mt-0">Deactivated</small></p>
                                                    <p class="mb-1 mt-0"><small class="text-dark mt-0">Products</small></p>
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-12 mb-0" id="ecommerceChartView">
                    <div class="card content-area p-0">
                        <div class="card card-shadow chart-height mb-0">
                            <!--<div class="m-3">Product Sales</div>-->
                            <div class="card-header card-header-transparent py-20 border-0">
                                <h4 class="float-left h6">Product Sales</h4>
                ...
                <div class="col-xl-6 col-12 mb-0" id="ecommerceChartView2">
                    <div class="card content-area p-0">
                        <div class="card card-shadow chart-height mb-0">
                            <!--<div class="m-3">Product Sales</div>-->
                            <div class="card-header card-header-transparent py-20 border-0">
                                <h4 class="float-left h6">Orders Count</h4>
                                <ul class="nav nav-pills nav-pills-rounded chart-action float-right btn-group" role="group">
            ...
            <?php /* ?>
            <div class="card  content-area pl-0 pr-0 pt-0 pb-0">
                <div class="card-innr">
                    <div class="row">
                        <div class="col-md-6">
