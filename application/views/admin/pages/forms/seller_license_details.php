                                            ...
                                            <div class="col-md-7">
                                                <div class="row fertilizer_license_div"  style="<?php echo ($seller_data->have_fertilizer_license==0) ? 'display: none;' : '';?>">
                                                    <div class="col-md-7 pb-lg-10 pt-lg-10">
                                                        ...
                                                        <a class="btn btn-browse btn-primary btn-rounded btn-sm mb-3" href="javascript:void(0);" onclick="$('#fertilizer_license_photo').click();">Select Photo</a>
                                                        <?php
                                                        if(file_exists($seller_data->fertilizer_license_photo) && $seller_data->fertilizer_license_photo!='')
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-3" href="<?php echo base_url().$seller_data->fertilizer_license_photo;?>" target="_blank">View Photo</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        <br />
                                                        ...
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-2" href="<?php echo base_url().$seller_data->fertilizer_license_pdf;?>" target="_blank">View PDF</a>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-7">
                                                <div class="row pesticide_license_div" style="<?php echo ($seller_data->have_pesticide_license_no==0) ? 'display: none;' : '';?>">
                                                    <div class="col-md-7 pb-lg-10 pt-lg-10">
                                                        <label>Upload Photo</label>
                                                        <div class="clearfix"></div>
                                                        <a class="btn btn-browse btn-primary btn-rounded btn-sm mb-3" href="javascript:void(0);" onclick="$('#pesticide_license_photo').click();">Select Photo</a>
                                                        <?php
                                                        if(file_exists($seller_data->pesticide_license_photo) && $seller_data->pesticide_license_photo!='')
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-3" href="<?php echo base_url().$seller_data->pesticide_license_photo;?>" target="_blank">View Photo</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        <br />
                                                        ...
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-2" href="<?php echo base_url().$seller_data->pesticide_license_pdf;?>" target="_blank">View PDF</a>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-7">
                                                <div class="row seeds_license_div" style="<?php echo ($seller_data->have_seeds_license_no==0) ? 'display: none;' : '';?>">
                                                    <div class="col-md-7 pb-lg-10 pt-lg-10">
                                                        <label>Upload Photo</label>
                                                        <div class="clearfix"></div>
                                                        <a class="btn btn-browse btn-primary btn-rounded btn-sm mb-3" href="javascript:void(0);" onclick="$('#seeds_license_photo').click();">Select Photo</a>
                                                        <?php
                                                        if(file_exists($seller_data->seeds_license_photo) && $seller_data->seeds_license_photo!='')
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-3" href="<?php echo base_url().$seller_data->seeds_license_photo;?>" target="_blank">View Photo</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        <br />
                                                        ...
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-2" href="<?php echo base_url().$seller_data->seeds_license_pdf;?>" target="_blank">View PDF</a>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-7">
                                                <div class="row agri_serv_license_div" style="<?php echo ($seller_data->have_agri_serv_license_no==0) ? 'display: none;' : '';?>">
                                                    <div class="col-md-7 pb-lg-3 pt-lg-3">
                                                        ...
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-2" href="<?php echo base_url().$seller_data->agri_serv_license_pdf;?>" target="_blank">View PDF</a>
                                                            <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-7">
                                                <div class="row agri_equip_license_div" style="<?php echo ($seller_data->have_agri_equip_license_no==0) ? 'display: none;' : '';?>">
                                                    <div class="col-md-7 pb-lg-3 pt-lg-3">
                                                        ...
                                                        {
                                                            ?>
                                                            <a style="margin-top: 0px;" class="btn btn-primary btn-rounded btn-sm mb-2" href="<?php echo base_url().$seller_data->agri_equip_license_pdf;?>" target="_blank">View PDF</a>
                                                            <?php
                                                        }
                                                        ?>
