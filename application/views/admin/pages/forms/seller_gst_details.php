                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <ul class="nav nav-tabs" id="myTab" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url('admin/sellers/gst_details?edit_id='.$user_id) ?>">GST</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col-md-12">
                            <div class="p-3">
                                <div class="col-md-5">
                                    <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('admin/sellers/save_gst_details/') ?>' method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row gst_div" style="<?php echo ($seller_data->have_gst_no==1) ? '' : 'display: none;';?>">
                                            <div class="col-md-7 pb-lg-10 pt-lg-10">
                                                ...
                                                {
                                                    ?>
                                                    <a class="btn btn-primary btn-rounded btn-sm btn-block-- mb-2" href="<?php echo base_url().$seller_data->gst_no_photo; ?>" target="_blank">View File</a>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="row non_gst_div" style="<?php echo ($seller_data->have_gst_no==2) ? '' : 'display: none;';?>">
                                            <div class="col-md-7 pb-lg-10 pt-lg-10">
                                                ...
                                                {
                                                    ?>
                                                    <a class="btn btn-primary btn-rounded btn-sm btn-block-- mb-2" href="<?php echo base_url().$seller_data->pan_no_photo; ?>" target="_blank">View File</a>
                                                    <?php
                                                }
                                                ?>
