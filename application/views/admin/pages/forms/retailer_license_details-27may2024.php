                                    ...
                                    <form id='basic-details-form' class='basic-details-form' action='<?php echo base_url('admin/retailers/save_license_details/') ?>' method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group fertilizer_license_div" style="<?php echo ($retailer_data->have_fertilizer_license==0) ? 'display: none;' : '';?>">
                                                    ...
                                                    <input type="date" class='form-control' placeholder="Issue Date" id="fert_lic_issue_date" name="fert_lic_issue_date" value="<?php echo $retailer_data->fert_lic_issue_date;?>"/>
                                                </div>
                                            </div>
                                            <?php */ ?>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group fertilizer_license_div" style="<?php echo ($retailer_data->have_fertilizer_license==0) ? 'display: none;' : '';?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {
                                                            ?>
                                                            <a class="btn btn-primary btn-rounded btn-md btn-block--" href="<?php echo base_url().$retailer_data->fertilizer_license_photo; ?>" target="_blank">View File</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group pesticide_license_div" style="<?php echo ($retailer_data->have_pesticide_license_no==0) ? 'display: none;' : '';?>">
                                                    <label>Issue Date</label>
                                                    <input type="date" class='form-control' placeholder="Issue Date" id="pest_lic_issue_date" name="pest_lic_issue_date" value="<?php echo $retailer_data->pest_lic_issue_date;?>"/>
                                                </div>
                                            </div>
                                            <?php */ ?>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group pesticide_license_div" style="<?php echo ($retailer_data->have_pesticide_license_no==0) ? 'display: none;' : '';?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {
                                                            ?>
                                                            <a class="btn btn-primary btn-rounded btn-md btn-block--" href="<?php echo base_url().$retailer_data->pesticide_license_photo; ?>" target="_blank">View File</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group seeds_license_div" style="<?php echo ($retailer_data->have_seeds_license_no==0) ? 'display: none;' : '';?>">
                                                    <label>Issue Date</label>
                                                    <input type="date" class='form-control' placeholder="Issue Date" id="seeds_lic_issue_date" name="seeds_lic_issue_date" value="<?php echo $retailer_data->seeds_lic_issue_date;?>"/>
                                                </div>
                                            </div>
                                            <?php */ ?>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group seeds_license_div" style="<?php echo ($retailer_data->have_seeds_license_no==0) ? 'display: none;' : '';?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {
                                                            ?>
                                                            <a class="btn btn-primary btn-rounded btn-md btn-block--" href="<?php echo base_url().$retailer_data->seeds_license_photo; ?>" target="_blank">View File</a>
                                                            <?php
                                                        }
                                                        ?>
                                                        </div>
