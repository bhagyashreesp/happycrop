            ...
            <div class="col-md-12">
                <div class="card card-info " id="section-to-print">
                    ...
                    <?php for ($i = 0; $i < count($sellers); $i++) {
                        $s_user_data = fetch_details(['id' => $sellers[$i]], 'users', 'email,mobile,address,country_code');
                        $seller_data = fetch_details(['user_id' => $sellers[$i]], 'seller_data', 'store_name,pan_number,tax_name,tax_number');
                    ?>
