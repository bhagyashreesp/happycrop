<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Manage Megamenu Block</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Megamenu Block </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Megamenu_blocks/add_megamenu_block'); ?>" method="POST" enctype="multipart/form-data">
                            <?php if (isset($fetched_data[0]['id'])) { ?>
                                <input type="hidden" id="edit_megamenu_block" name="edit_megamenu_block" value="<?= @$fetched_data[0]['id'] ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row show_type_1" style="<?php echo (isset($fetched_data[0]['show_type']) && $fetched_data[0]['show_type']=='1') ? '' :  'display: none;';?>">
                                    <label for="main_category" class="control-label">Main Megamenu</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group row show_type_1" style="<?php echo (isset($fetched_data[0]['show_type']) && $fetched_data[0]['show_type']=='1') ? '' :  'display: none;';?>">
                                    <label for="sub_categories" class="control-label">Sub Megamenu</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Megamenu Block' : 'Add Megamenu Block' ?></button>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Edit Megamenu Block Details</h5>
