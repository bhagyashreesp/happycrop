                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools row ">
                                <a href="<?= base_url() . 'admin/webinars/manage-new-webinar' ?>" class="btn btn-block  btn-outline-primary btn-sm">Add Webinar </a>
                            </div>
                        </div>
                        <div class="card-innr">
