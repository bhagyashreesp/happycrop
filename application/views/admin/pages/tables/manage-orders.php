                            ...
                            <div class="gaps-1-5x row d-flex adjust-items-center">
                                ...
                                <div class="row col-12 d-flex">
                                        ...
                                        <div class="small-box bg-white">
                                            <div class="inner text-center">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders');?>" target="_self">
                                                    <h5><?= $status_counts['total_orders'] ?></h5>
                                                    <p>Total Orders</p>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/6');?>" target="_blank">
                                    ...
                                    <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/1');?>" target="_blank">
                                    ...
                                    <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/2');?>" target="_blank">
                                    ...
                                    <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/3');?>" target="_blank">
                                     ...
                                     <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/4');?>" target="_blank">
                                     ...
                                     <div class="col">
                                        <div class="small-box  bg-white">
                                            <div class="inner text-left">
                                                <a class="text-dark" href="<?php echo base_url('admin/orders/show_orders/5');?>" target="_blank">
                                    ...
                                    <div class="form-group col-md-3">
                                        <div>
                                            ...
                                            <select id="order_status" name="order_status" placeholder="Select Status" required="" class="form-control">
                                                ...
                                                <option value="payment_ack">Transaction details received from retailer</option>
                                                <option value="send_payment_confirmation">Payment confirmation sent to retailer</option>
                                                <option value="send_invoice">E-way bill and invoices sent to retailer</option>
                                                <?php /* ?>
                                                <option value="shipped">Shipped</option>
                                                <?php */ ?>
                                                <option value="delivered">Order delivered</option>
                                                <option value="issue_closed">Issue resolved. Make payment</option>
                                                <option value="send_mfg_payment_ack">Transaction details shared with manufacturer</option>
                                                <option value="send_mfg_payment_confirmation">Payment receipt received</option>
                                    ...
                                    <table class='table-striped' data-toggle="table" data-url="<?= base_url('admin/orders/view_order_items') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="oi.id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel","csv"]' data-export-options='{"fileName": "order-item-list","ignoreColumn": ["state"] }' data-query-params="orders_query_params">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="username" data-sortable='true'>Retailer Name</th>
                                                <th data-field="seller_name" data-sortable='true'>Manufacturer Name</th>
