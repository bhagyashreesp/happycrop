...
class Orders extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $orders_count['in_process_orders'] = admin_orders_count(array('received','payment_demand','payment_ack','schedule_delivery','send_payment_confirmation',), $this->data['user_id']);
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            else 
            {
                ...
                if($this->Order_model->add_complaint_msg($data)) {
                    ...
                    $this->db->update('orders', array('order_status' => 'complaint_msg'), array('id' => $order_id));
