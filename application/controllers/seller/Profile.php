                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control editable" placeholder="Brand Name" id="brand_name_'.$seller_brand['id'].'" name="brand_name_'.$seller_brand['id'].'" value="'.$seller_brand['brand_name'].'"/>
                                </div>
                            </div>
                            <div class="col-md-6">
