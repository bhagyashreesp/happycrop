...
class Products extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if($seller!='')
        {
            $this->db->select('user_id, company_name, logo, min_order_value');
            $this->db->from('seller_data');
            $this->db->where('slug', $seller);
            $query = $this->db->get();
    ...
    public function details($slug = '')  
    {
        ...
        $this->data['related_products'] = fetch_product($user_id, NULL, NULL, $product['product'][0]['category_id'], 12, NULL, NULL, NULL, NULL, NULL, NULL, $product['product'][0]['id']);
