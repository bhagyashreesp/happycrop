        ...
        */
            ...
            if (!$this->form_validation->run()) {
                ...
                {                    
                    ...
                    $this->response['error'] = false;
                    $this->response['message'] = "Your order has been placed successfully. ".$order_msg."<br/> <u><a href='".base_url('my-account/orders')."'>View order details</a></u>";
