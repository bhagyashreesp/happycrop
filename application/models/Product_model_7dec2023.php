...
class Product_model extends CI_Model
{
    ...
    public function get_product_details($flag = NULL, $seller_id = NULL,$p_status = NULL,$super_category_id = 0)
    {
        ...
        $search_res = $this->db->select('product_variants.id AS id, p.id as pid ,p.rating,p.no_of_ratings,p.name, p.slug, p.type, p.image, p.status, p.product_stock_status, product_variants.price , product_variants.special_price, product_variants.stock, p.super_category_id ')
