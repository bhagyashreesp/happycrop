...
$config['system_modules'] = [
    ...
    'category_block' =>  array('create', 'read', 'update', 'delete'),
    'super_categories' =>  array('create', 'read', 'update', 'delete'),
    'insect_pests' =>  array('create', 'read', 'update', 'delete'),
    'category_order' =>  array('read', 'update'),
    'formulation' =>  array('create', 'read', 'update', 'delete'),
    'formulation_order' =>  array('read', 'update'),
    ...
    'retailer' => array('create', 'read', 'update', 'delete'),
];
